...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}export function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (authorData, mainAuthor) {
...
pug_mixins["authorBlock"] = pug_interp = function(authorData, isPageAuthor, chpsUrl){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["author-block",{'followed': isPageAuthor}], [false,true]), false, false)) + "\u003E";
if (((authorData || {}).authorAvatar)) {
pug_html = pug_html + "\u003Ca" + (" class=\"author-avatar\""+pug_attr("href", authorData.profileUrl, true, false)+pug_attr("style", pug_style(`background-image: url(${authorData.mediumAvatar})`), true, false)) + "\u003E\u003Cimg" + (" class=\"author-img\""+pug_attr("src", authorData.authorAvatar, true, false)+pug_attr("alt", authorData.name, true, false)) + "\u002F\u003E\u003C\u002Fa\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"author-info\"\u003E\u003Ca" + (" class=\"author-name\""+pug_attr("href", chpsUrl, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = authorData.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003Cdiv class=\"author-bio\"\u003E" + (pug_escape(null == (pug_interp = authorData.shortBio) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if ((!isPageAuthor)) {
pug_html = pug_html + "\u003Cfbs-cordial" + (" type=\"Follow\""+pug_attr("natural-id", authorData.naturalId, true, false)+pug_attr("author-slug", authorData.slug, true, false)+" page-position=\"bottom\"") + "\u003E\u003Cdiv class=\"following-label\"\u003E";
pug_mixins["icon"]('checkMark');
pug_html = pug_html + "\u003Cspan\u003EFollowing\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Ffbs-cordial\u003E";
}
else {
pug_html = pug_html + "\u003Ca class=\"following-label following\" href=\"https:\u002F\u002Faccount.forbes.com\u002Ffollowing\" target=\"blank\"\u003E";
pug_mixins["icon"]('checkMark');
pug_html = pug_html + "\u003Cspan\u003EFollowing\u003C\u002Fspan\u003E\u003C\u002Fa\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
pug_html = pug_html + "\u003Cdiv class=\"following-overlay\"\u003E\u003Cbutton class=\"close-button\"\u003E";
pug_mixins["icon"]('close');
pug_html = pug_html + "\u003C\u002Fbutton\u003E\u003Cdiv class=\"following\"\u003E\u003Cdiv class=\"following-title\"\u003EYou Followed\u003C\u002Fdiv\u003E";
pug_mixins["authorBlock"](mainAuthor, true, mainAuthor.profileUrl);
pug_html = pug_html + "\u003Cdiv class=\"following-outro\"\u003EYou will receive an email from writers you follow. You can &nbsp\u003Ca href=\"https:\u002F\u002Faccount.forbes.com\u002Ffollowing\"\u003Emanage your preferences here.\u003C\u002Fa\u003E&nbsp Cancel any time.\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"recommended\"\u003E\u003Cdiv class=\"recommended-title\"\u003E\u003Cspan\u003ERecommended Writers\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"recommended-authors\"\u003E";
// iterate authorData
;(function(){
  var $$obj = authorData;
...
pug_mixins["authorBlock"](element, false, `https://www.forbes.com${element.authorChpsUrl}`);
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cspan class=\"there-are-no-additional-writers\"\u003EThere are no additional writers to follow at this time.\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
    }.call(this, "authorData" in locals_for_with ?
        locals_for_with.authorData :
        typeof authorData !== 'undefined' ? authorData : undefined, "mainAuthor" in locals_for_with ?
        locals_for_with.mainAuthor :
        typeof mainAuthor !== 'undefined' ? mainAuthor : undefined));
    ;;return pug_html;}