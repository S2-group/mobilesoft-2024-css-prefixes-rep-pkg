...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}export function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (isMobile, row, rowLetterId, rowTitle, showDescription, svgIcons) {
...
pug_mixins["paidContentLabelHomePageVideo"] = pug_interp = function(item){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"paid-content__video-thumbnail-container\"\u003E";
if ((item.type === 'connoisseur' || item.type === 'ad' || item.type === 'insights')) {
pug_html = pug_html + "\u003Cspan class=\"paid-content__company-name\"\u003E" + (pug_escape(null == (pug_interp = item.brandName) ? "" : pug_interp)) + "&nbsp;\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"paid-content__text-wrapper\"\u003E\u003Cspan" + (pug_attr("class", pug_classes(["paid-content__type",`paid-content--${item.type}`], [false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.label) ? "" : pug_interp)) + "&nbsp;\u003C\u002Fspan\u003E\u003Cspan class=\"paid-content__ftc-label\"\u003E" + (pug_escape(null == (pug_interp = item.ftcLabel) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
...
pug_mixins["iconPreview"](item, (!!item.eyebrows && rowTitle !== 'editors picks'));
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
if ((item.eyebrows)) {
pug_html = pug_html + "\u003Ch3" + (pug_attr("class", pug_classes(["preview__eyebrows",(rowTitle !== 'editors picks') ? 'preview__eyebrows--mobile-left': ''], [false,true]), false, false)+pug_attr("aria-label", item.eyebrows, true, false)+" role=\"note\"") + "\u003E\u003Cspan" + (pug_attr("style", pug_style({'background': item.color}), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.eyebrows) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fh3\u003E";
}
pug_mixins["photoCreditLarge"](item);
pug_html = pug_html + "\u003Cdiv" + (" class=\"card--large__color-bar\""+pug_attr("style", pug_style({'color': item.color}), true, false)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fa\u003E";
};
pug_mixins["previewSmall"] = pug_interp = function(item, rowTitle, rowLetterId, isList){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Ca" + (" class=\"preview ratio16x9\""+pug_attr("href", item.url, true, false)+pug_attr("aria-label", `${item.title}, graphic`, true, false)+pug_attr("data-ga-track", isList ? `Homepage Forbes List - ${item.title}` : `Channel - Block ${rowLetterId} - ${item.type} - Position ${item.trackingIndex} - ${item.title}`, true, false)) + "\u003E\u003Cprogressive-image" + (" class=\"preview__image\""+pug_attr("background-image", item.image, true, false)) + "\u003E\u003C\u002Fprogressive-image\u003E";
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"preview\"\u003E\u003Ca" + (" class=\"preview__link ratio1x2\""+pug_attr("href", item.url, true, false)+pug_attr("aria-label", `${item.title}, graphic`, true, false)+pug_attr("data-ga-track", `Channel - Block ${rowLetterId} - ${item.type} - Position ${item.trackingIndex} - ${item.title}`, true, false)) + "\u003E\u003Cprogressive-image" + (" class=\"preview__image\""+pug_attr("background-image", item.image, true, false)) + "\u003E\u003C\u002Fprogressive-image\u003E";
pug_mixins["iconPreview"](item);
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["card",item.cardClass,{'csf-block': csfBlock},{'channel__lazy-item': type === 'small'},{'channel__lazy-item-delay-400': type === 'small' && index !== 0}], [false,true,true,true,true]), false, false)+pug_attr("data-video-id", item.videoId, true, false)+pug_attr("data-video-title", item.videoTitle, true, false)) + "\u003E";
switch (type){
case 'large':
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
if ((item.author)) {
if ((((item.paidLabel || {}).showByline) || !item.paidLabel)) {
...
pug_html = pug_html + ("\u003Ca" + (" class=\"headlink\""+pug_attr("href", item.url, true, false)+pug_attr("data-ga-track", `Channel - Block ${rowLetterId} - ${rowTitle} - ${item.type} - Position ${item.trackingIndex} - ${item.title}`, true, false)) + "\u003E\u003Ch3 class=\"h3--dense\"\u003E\u003Cspan\u003E" + (pug_escape(null == (pug_interp = item.title) ? "" : pug_interp)));
if (((item.video || {}).duration || '')) {
pug_html = pug_html + "\u003Cspan class=\"byline__duration\"\u003E| " + (pug_escape(null == (pug_interp = item.video.duration || '') ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
...
pug_html = pug_html + "\u003Ca" + (" class=\"headlink h4--dense\""+pug_attr("href", item.url, true, false)+pug_attr("data-ga-track", `Channel - Block ${rowLetterId} - ${rowTitle} - ${item.type} - Position ${item.trackingIndex} - ${item.title}`, true, false)) + "\u003E\u003Cspan\u003E" + (pug_escape(null == (pug_interp = item.title) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fa\u003E";
if (((item.video || {}).duration || '')) {
pug_html = pug_html + "\u003Cspan class=\"byline__duration\"\u003E| " + (pug_escape(null == (pug_interp = item.video.duration || '') ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
pug_mixins["byline"](item, rowTitle, rowLetterId);
...
pug_html = pug_html + "\u003Cdiv class=\"channel__content\"\u003E\u003Cdiv class=\"channel__lazy-item\"\u003E";
pug_mixins["card"](row.blocks[0].items.largeCard, 'large', false, row.title, row.rowIdLetter);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
pug_mixins["channelSidebar"](row);
pug_html = pug_html + "\u003Cdiv class=\"channel__divider\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"channel__columns channel__lazy-item channel__lazy-item-delay-600\"\u003E\u003Cdiv class=\"channel__column\"\u003E";
if ((isMobile)) {
pug_html = pug_html + "\u003Cdiv class=\"fbs-ad--ntv-mobchannel-wrapper\"\u003E\u003Cfbs-ad" + (" position=\"ntv-mobchannel\""+pug_attr("custom-targeting", `ntv-channel:${row.title.replace(/ /g,'-').toLowerCase().trim()}`, true, false)) + "\u003E\u003C\u002Ffbs-ad\u003E";
...
if ((!isMobile)) {
pug_html = pug_html + "\u003Cdiv class=\"fbs-ad--ntv-deskchannel-wrapper\"\u003E\u003Cfbs-ad" + (" position=\"ntv-deskchannel\""+pug_attr("custom-targeting", `ntv-channel:${row.title.replace(/ /g,'-').toLowerCase().trim()}`, true, false)) + "\u003E\u003C\u002Ffbs-ad\u003E";
pug_mixins["ntvLoadingPlaceholder"](true);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cbutton class=\"channel__show-more-btn\"\u003E\u003Cspan\u003EShow More\u003C\u002Fspan\u003E\u003Cspan\u003E" + (null == (pug_interp = svgIcons.arrowRight) ? "" : pug_interp) + "\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
}
    }.call(this, "isMobile" in locals_for_with ?
        locals_for_with.isMobile :
        typeof isMobile !== 'undefined' ? isMobile : undefined, "row" in locals_for_with ?
        locals_for_with.row :
        typeof row !== 'undefined' ? row : undefined, "rowLetterId" in locals_for_with ?
        locals_for_with.rowLetterId :
        typeof rowLetterId !== 'undefined' ? rowLetterId : undefined, "rowTitle" in locals_for_with ?
        locals_for_with.rowTitle :
        typeof rowTitle !== 'undefined' ? rowTitle : undefined, "showDescription" in locals_for_with ?
        locals_for_with.showDescription :
        typeof showDescription !== 'undefined' ? showDescription : undefined, "svgIcons" in locals_for_with ?
        locals_for_with.svgIcons :
        typeof svgIcons !== 'undefined' ? svgIcons : undefined));
    ;;return pug_html;}