...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}export function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (index, isMobile, isVetted, item, serverData) {
      pug_mixins["iconPreview"] = pug_interp = function(item, mobileLeftEyebrow){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if ((item.type === 'video' || (item.naturalId ? item.naturalId.includes('video') : ''))) {
pug_html = pug_html + ("\u003Cdiv" + (pug_attr("class", pug_classes(["card__icon","card__icon--preview",{'card__icon--preview-eyebrow': mobileLeftEyebrow}], [false,false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = 'WATCH') ? "" : pug_interp)));
pug_mixins["icon"]('play-circle');
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
if ((item.type === 'connoisseur' || item.type === 'ad' || item.type === 'insights')) {
pug_html = pug_html + "\u003Cspan class=\"paid-content__company-name\"\u003E" + (pug_escape(null == (pug_interp = item.brandName) ? "" : pug_interp)) + "&nbsp;\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003Cdiv class=\"paid-content__text-wrapper\"\u003E\u003Cspan" + (pug_attr("class", pug_classes(["paid-content__type",`paid-content--${item.type}`], [false,true]), false, false)+pug_attr("style", pug_style({ 'color': item.primaryColor }), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.label) ? "" : pug_interp)) + "&nbsp;\u003C\u002Fspan\u003E\u003Cspan class=\"paid-content__ftc-label\"\u003E" + (pug_escape(null == (pug_interp = item.ftcLabel) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
};
pug_mixins["paidContentLabelDisclaimer"] = pug_interp = function(item, companyLink, isGroupBlog){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if ((['ad', 'insights', 'connoisseur'].includes(item.type) && companyLink)) {
pug_html = pug_html + "\u003Ca" + (" class=\"company-label-link\""+pug_attr("href", companyLink, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.brandName) ? "" : pug_interp)) + "&nbsp;\u003C\u002Fa\u003E";
}
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["paid-content__type",`paid-content--${item.type}`], [false,true]), false, false)+pug_attr("style", pug_style({ 'color': item.primaryColor }), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.label) ? "" : pug_interp)) + "&nbsp;";
if ((item.showDisclaimer || item.hoverDisclaimer)) {
pug_html = pug_html + "\u003Cspan class=\"hover-disclaimer\"\u003E" + (pug_escape(null == (pug_interp = item.disclaimerText || item.hoverDisclaimerText) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003C\u002Fspan\u003E\u003Cspan class=\"paid-content__ftc-label\"\u003E" + (pug_escape(null == (pug_interp = item.ftcLabel) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
};
...
pug_mixins["streamBylineAuthor"] = pug_interp = function(author, index, isCoAuthor){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if (((author || {}).name)) {
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["byline__author",{'author_shopping': (serverData || {}).isVetted}], [false,true]), false, false)) + "\u003E";
if ((isCoAuthor)) {
...
pug_html = pug_html + "\u003Ca" + (" class=\"byline__author-name\""+pug_attr("data-ga-track", `${ (serverData || {} ).channelName} - Stream - Position ${index} - ${author.name}`, true, false)+pug_attr("href", author.url, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = author.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
if ((item.paidLabel.authorLabel)) {
pug_html = pug_html + "\u003Cspan class=\"byline__author-type\"\u003E" + (pug_escape(null == (pug_interp = item.paidLabel.authorLabel) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
else
...
pug_mixins["streamByline"] = pug_interp = function(item, index){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if ((item.type !== 'video')) {
pug_html = pug_html + "\u003Cspan class=\"byline\"\u003E\u003Cdiv class=\"byline__author-group\"\u003E";
if ((item.byline)) {
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["byline__author",{'author_shopping': (serverData || {}).isVetted}], [false,true]), false, false)) + "\u003E\u003Cspan class=\"byline__by\"\u003EBy\u003C\u002Fspan\u003E\u003Cspan class=\"byline__author-name\"\u003E" + (pug_escape(null == (pug_interp = item.byline) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
}
else {
pug_mixins["streamBylineAuthor"](item.author, index);
...
pug_mixins["streamBylineAuthor"](coAuthor, index, true);
      }
  } else {
    var $$l = 0;
...
pug_mixins["socialShareButtons"] = pug_interp = function(social){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"social-share\"\u003E\u003Cspan class=\"social-share__arrow\"\u003E";
pug_mixins["icon"]('sharrow');
pug_html = pug_html + "\u003C\u002Fspan\u003E\u003Cdiv class=\"social-share__icon-wrapper\"\u003E\u003Ca" + (" class=\"social-share__icon social-share__icon--facebook\""+pug_attr("href", social.facebook, true, false)+" rel=\"noopener noreferrer\" target=\"_blank\" data-src=\"Facebook\" aria-label=\"Share Facebook\" data-ga-track=\"Facebook Click\"") + "\u003E";
pug_mixins["icon"]('facebook');
pug_html = pug_html + "\u003C\u002Fa\u003E\u003Ca" + (" class=\"social-share__icon social-share__icon--twitter\""+pug_attr("href", social.twitter, true, false)+" rel=\"noopener noreferrer\" target=\"_blank\" data-src=\"Twitter\" aria-label=\"Share Twitter\" data-ga-track=\"Twitter Click\"") + "\u003E";
pug_mixins["icon"]('twitter');
pug_html = pug_html + "\u003C\u002Fa\u003E\u003Ca" + (" class=\"social-share__icon social-share__icon--linkedin\""+pug_attr("href", social.linkedIn, true, false)+" rel=\"noopener noreferrer\" target=\"_blank\" data-src=\"LinkedIn\" aria-label=\"Share Linkedin\" data-ga-track=\"LinkedIn Click\"") + "\u003E";
pug_mixins["icon"]('linkedin');
pug_html = pug_html + "\u003C\u002Fa\u003E\u003Ca" + (" class=\"desktop email social-share__icon social-share__icon--email\""+pug_attr("href", social.email, true, false)+" aria-label=\"Share Email\" data-ga-track=\"Email Click\"") + "\u003E";
pug_mixins["icon"]('email');
pug_html = pug_html + "\u003C\u002Fa\u003E\u003Ca class=\"social-share__icon search-hidden-icon search-hidden-star\"\u003E\u003Cdiv class=\"star-img\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
var isVetted = (serverData || {}).isVetted
pug_mixins["longStreamTitle"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"stream-content\"\u003E\u003Ca" + (pug_attr("class", pug_classes(["stream-item__title","long-title",{'title-shopping': isVetted}], [false,false,true]), false, false)+pug_attr("data-ga-track", `${(serverData || {} ).channelName} - Stream - Position ${index} - ${item.title}`, true, false)+pug_attr("href", item.url, true, false)+pug_attr("aria-label", !!item.url.includes('video') && `Click to watch video ${item.title}`, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.title) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
if ((item.url.includes('newsletters') && !item.hasAccess && !item.isFreeNewsletter && !item.removePaywall)) {
pug_html = pug_html + "\u003Cspan class=\"stream-item__lock-icon title-icon\" aria-label=\"Lock Icon\" role=\"text\"\u003E";
pug_mixins["icon"]('lock');
pug_html = pug_html + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
pug_mixins["shortStreamTitle"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + ("\u003Ca" + (pug_attr("class", pug_classes(["stream-item__title",{'title-shopping': isVetted}], [false,true]), false, false)+pug_attr("data-ga-track", `${(serverData || {} ).channelName} - Stream - Position ${index} - ${item.title}`, true, false)+pug_attr("href", item.url, true, false)+pug_attr("aria-label", !!item.url.includes('video') && `Click to watch video ${item.title}`, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.title) ? "" : pug_interp)));
if ((item.url.includes('newsletters') && !item.hasAccess && !item.isFreeNewsletter && !item.removePaywall)) {
pug_html = pug_html + "\u003Cspan class=\"stream-item__lock-icon\" aria-label=\"Lock Icon\" role=\"text\"\u003E";
pug_mixins["icon"]('lock');
pug_html = pug_html + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003C\u002Fa\u003E";
};
pug_html = pug_html + "\u003Carticle" + (pug_attr("class", pug_classes(["stream-item","et-promoblock-removeable-item","et-promoblock-star-item",{'stream-shopping': isVetted }], [false,false,false,true]), false, false)+pug_attr("data-date", item.date, true, false)+pug_attr("data-id", item.id, true, false)+pug_attr("data-et-id", item.naturalId, true, false)) + "\u003E\u003Cdiv class=\"stream-item__text\"\u003E";
if ((item.paidLabel.brandName)) {
pug_html = pug_html + "\u003Cdiv class=\"stream-item__label\"\u003E";
pug_mixins["paidContentLabel"](item.paidLabel);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
}
else
if ((item.paidLabel.type)) {
pug_html = pug_html + "\u003Cdiv class=\"stream-item__label\"\u003E";
if ((item.paidLabel.companyName)) {
pug_html = pug_html + "\u003Cspan class=\"stream-item__label-company\"\u003E" + (pug_escape(null == (pug_interp = item.paidLabel.companyName) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["stream-item__label-type",`stream-item__label-${item.paidLabel.typeClassName}`], [false,true]), false, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.paidLabel.type) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan class=\"stream-item__promoted\"\u003E&nbsp;| Paid Program\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
}
if ((item.eyebrows && isVetted)) {
pug_html = pug_html + "\u003Cspan class=\"eyebrow-label\"\u003E" + (pug_escape(null == (pug_interp = item.eyebrows || '') ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
if ((item.badge && item.badge.displayName)) {
pug_html = pug_html + "\u003Ca" + (pug_attr("class", pug_classes(["stream-item__badge",{'eyebrow-label': isVetted}], [false,true]), false, false)+pug_attr("data-ga-track", `${(serverData || {} ).channelName} - Stream - Position ${index} - ${item.badge.displayName}`, true, false)+pug_attr("href", item.badge.streamUrl, true, false)) + "\u003E" + (null == (pug_interp = `${item.badge.displayName}&nbsp;&nbsp;|&nbsp;&nbsp;`) ? "" : pug_interp) + "\u003C\u002Fa\u003E";
}
if ((!(serverData || {}).isNewsletter && item.pageViews)) {
pug_html = pug_html + "\u003Cdiv class=\"stream-item__views\"\u003E" + (null == (pug_interp = `${item.pageViews} views&nbsp;&nbsp;|&nbsp;&nbsp;`) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E";
}
if ((item.magazine)) {
pug_html = pug_html + "\u003Cdiv" + (" class=\"stream-item__date\""+pug_attr("data-date", item.date, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = `From the ${item.magazine.displayDate} issue`) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
else {
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["stream-item__date",{'date-shopping': isVetted }], [false,true]), false, false)+pug_attr("data-date", item.date, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = item.timestamp) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003Ch3\u003E";
if ((!isMobile)) {
pug_mixins["shortStreamTitle"]();
}
else {
pug_mixins["longStreamTitle"]();
}
pug_html = pug_html + "\u003C\u002Fh3\u003E";
if ((!isVetted)) {
pug_html = pug_html + "\u003Cdiv class=\"stream-item__description\"\u003E" + (pug_escape(null == (pug_interp = item.description) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes([{'social-wrapper_shopping' : isVetted }], [true]), false, false)) + "\u003E\u003Cdiv class=\"stream-item__byline-social-wrapper\"\u003E";
if ((item.author && item.showAuthorByline && item.type !== 'slide')) {
pug_mixins["streamByline"](item, index);
}
if ((!isVetted)) {
pug_mixins["socialShareButtons"](item.social);
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
if ((item.showThumbnail || isVetted)) {
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["stream-item__fallback-image",{'fallback-image_shopping': isVetted}], [false,true]), false, false)) + "\u003E\u003Ca" + (pug_attr("class", pug_classes(["stream-item__image","ratio16x9",{'fs-video-poster': item.type === 'video'}], [false,false,true]), false, false)+pug_attr("style", pug_style(`background-image: url("${item.image}")`), true, false)+pug_attr("href", item.url, true, false)+pug_attr("data-ga-track", `${(serverData || {} ).channelName} - Stream - Position ${index} - ${item.title}`, true, false)+pug_attr("aria-label", `Graphic ${item.title}`, true, false)) + "\u003E";
pug_mixins["iconPreview"](item);
pug_html = pug_html + "\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003C\u002Farticle\u003E";
    }.call(this, "index" in locals_for_with ?
        locals_for_with.index :
        typeof index !== 'undefined' ? index : undefined, "isMobile" in locals_for_with ?
        locals_for_with.isMobile :
        typeof isMobile !== 'undefined' ? isMobile : undefined, "isVetted" in locals_for_with ?
        locals_for_with.isVetted :
        typeof isVetted !== 'undefined' ? isVetted : undefined, "item" in locals_for_with ?
        locals_for_with.item :
        typeof item !== 'undefined' ? item : undefined, "serverData" in locals_for_with ?
        locals_for_with.serverData :
        typeof serverData !== 'undefined' ? serverData : undefined));
    ;;return pug_html;}