...
pug_mixins["storyBlock"] = pug_interp = function(story, num){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv" + (" class=\"for-you__story\""+pug_attr("id", `for-you__story-${num}`, true, false)) + "\u003E\u003Cdiv class=\"for-you__label\"\u003E" + (pug_escape(null == (pug_interp = firstName ? `${firstName}'s PICKS` : 'FOR YOU') ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
if (firstName) {
if ((story.primaryChannel)) {
pug_html = pug_html + "\u003Ca" + (" class=\"for-you__eyebrow\""+pug_attr("href", story.primaryChannel.url, true, false)+pug_attr("data-ga-track", `Homepage For You - Eyebrow - ${story.naturalId}`, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = story.primaryChannel.sectionName || story.primaryChannel.channelName || '') ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
}
else {
pug_html = pug_html + "\u003Ca" + (" class=\"for-you__eyebrow\""+pug_attr("href", story.channel_url, true, false)+pug_attr("data-ga-track", `Homepage For You - Eyebrow - ${story.naturalid}`, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = story.channelname || story.sectionname || '') ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
}
}
else {
pug_html = pug_html + "\u003Cp class=\"for-you__eyebrow for-you-premium\"\u003E" + (pug_escape(null == (pug_interp = 'PREMIUM') ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
}
pug_html = pug_html + "\u003Ca" + (" class=\"for-you__headline for-you__headline--animate\""+pug_attr("href", `${story.uri}?utm_source=for_you_${num}`, true, false)+" target=\"_self\""+pug_attr("id", `for-you__headline-${num}`, true, false)+pug_attr("natural-id", story.naturalid || story.naturalId, true, false)+pug_attr("data-ga-track", `Homepage For You - Article ${num} - ${story.naturalid || story.naturalId}`, true, false)) + "\u003E" + (pug_escape(null == (pug_interp = story.title) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003Cdiv class=\"for-you__icons-wrapper\"\u003E\u003Cdiv class=\"for-you__thumbs-icons\"\u003E\u003Cdiv class=\"for-you__refresh\" role=\"button\" tabindex=\"0\"\u003E";
pug_mixins["icon"]('replay');
pug_html = pug_html + "\u003Cspan class=\"for-you__icon-msg\"\u003EShow me something different\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"for-you__check-mark for-you__check-mark--hide\"\u003E";
pug_mixins["icon"]('checkMark');
pug_html = pug_html + "\u003Cspan class=\"for-you__check-mark-msg\"\u003EThanks! You'll see more stories like this.\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
if ((stories)) {
pug_html = pug_html + "\u003Cdiv class=\"for-you__stories-wrapper\"\u003E";
// iterate stories
;(function(){
  var $$obj = stories;
  if ('number' == typeof $$obj.length) {
      for (var num = 0, $$l = $$obj.length; num < $$l; num++) {
        var story = $$obj[num];
pug_mixins["storyBlock"](story, num+1);
      }
  } else {
    var $$l = 0;
    for (var num in $$obj) {
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"for-you__story-divider\"\u003E\u003C\u002Fdiv\u003E";
}
    }.call(this, "firstName" in locals_for_with ?
        locals_for_with.firstName :
        typeof firstName !== 'undefined' ? firstName : undefined, "stories" in locals_for_with ?
        locals_for_with.stories :
        typeof stories !== 'undefined' ? stories : undefined));
    ;;return pug_html;}