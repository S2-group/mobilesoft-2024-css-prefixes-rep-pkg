define("@baidu/aging-tools-pc/dist/index", ["san", "tslib"], function (n, t) {
    ...
    (i = [
                  ...
                  return (
                    "function" == typeof n &&
                      ...
                      n.prototype.constructor &&
                        t.push(n.prototype.constructor.prototype)),
                    t
                  );
                })(n),
                r = 0;
            ...
            return (
              ...
              (t.i = function (n, e, i) {
                ...
                for (var r = 0; r < n.length; r++) {
                  ...
                  (i && o[l[0]]) ||
                    (e &&
                      (l[2] = l[2] ? "".concat(e, " and ").concat(l[2]) : e),
                    t.push(l));
                }
              }),
              t
      ...
      function (n, t, e) {
        ...
        function i(n, t) {
          for (var e = [], i = {}, o = 0; o < t.length; o++) {
            var a = t[o],
              s = a[0],
              a = { id: n + ":" + o, css: a[1], media: a[2], sourceMap: a[3] };
        ...
        function s(n) {
          for (var t = 0; t < n.length; t++) {
            ...
            if (i) {
              ...
              i.parts.length > e.parts.length &&
                (i.parts.length = e.parts.length);
            } else {
              for (var a = [], o = 0; o < e.parts.length; o++)
                a.push(l(e.parts[o]));
              d[e.id] = { id: e.id, refs: 1, parts: a };
            }
          }
        }
        function r() {
        ...
        function l(n) {
          var t,
            e,
            i,
            a = document.querySelector("style[" + m + '~="' + n.id + '"]');
          if (a) {
            if (f) return o;
        ...
        function u(n, t, e, i) {
          (e = e ? "" : i.css),
            n.styleSheet
              ? (n.styleSheet.cssText = b(t, e))
              : ((i = document.createTextNode(e)),
                (e = n.childNodes)[t] && n.removeChild(e[t]),
                e.length ? n.insertBefore(i, e[t]) : n.appendChild(i));
        }
        if (
          (e.r(t),
          ...
          "undefined" != typeof DEBUG && DEBUG && !t)
        )
          throw new Error(
        ...
        var h,
          d = {},
          c = t && (document.head || document.getElementsByTagName("head")[0]),
          g = null,
          p = 0,
          f = !1,
          y = null,
            ...
            !e[n] ||
              (0 <=
                (t = (function (n, t) {
                  for (
                    var e = 0;
                    e < n.length && n[e].toString() !== t.toString();
      ...
      function (n, t, e) {
        ...
        var o,
          a = e(1),
          s = e(0),
          r = a.__importDefault(e(24)),
          l = a.__importDefault(e(7)),
          u = e(52),
          h = a.__importDefault(e(53)),
          d = e(15),
          h =
            ((o = s.Component),
            a.__extends(i, o),
            (i.prototype.initData = function () {
              return {
                ...
                quickType: "",
                statusList: [
                  ["color", "scale", "cursor", "cross", "voice", "bigText"],
                  ["", "", "", "", "", ""],
                ],
                totalWidth: "100%",
                from: "result",
            ...
            (i.prototype.attached = function () {
              ...
              document.addEventListener("keydown", i),
                ...
                (i = this.data.get("event")),
                (e = function () {
                  (n.data.get("show") || n.data.get("showArea")) &&
                    (n.showToast(), n.hideTools(), n.clearCompletely("quit"));
                }),
                this.data.set("closeFn", e),
                i && i.on("aging-tools.close", e),
                this.addPageDescrib();
            }),
            (i.prototype.setTimeout = function (n, t, e) {
              clearTimeout(this.data.get(n)),
                this.data.set(n, setTimeout(t, e));
            }),
            (i.prototype.clearTimeout = function () {
              clearTimeout(this.data.get("initReader")),
                clearTimeout(this.data.get("focusReader"));
            }),
            (i.prototype.showToast = function () {
              var n = $("body"),
                t = this.data.get("toastTimer");
              0 === $(".aging-toast").length &&
                n.append('<div class="aging-toast">已为您关闭无障碍导读</div>'),
                clearTimeout(t),
                setTimeout(function () {
                  $(".aging-toast").remove();
                }, 2e3);
            }),
            (i.prototype.logSend = function (n) {
              var t = this.data.get("logService");
              t && "function" == typeof t && t(n);
            }),
            (i.prototype.handleScale = function () {
            ...
            (i.prototype.init = function () {
              ...
              null !== n
                ? (this.showTools(),
                  n && ((n = n.split("_")), this.data.set("statusList[1]", n)))
                : this.hideTools();
            }),
            (i.prototype.getKeyType = function (n) {
              var t,
                e = this.data.get("behavior");
              "keydown" === n.type
                ? (e.push(n.keyCode),
                  "changeFocus" === (t = u.changeFocus(n.keyCode)) &&
                    (d.interveneFocus(n), this.readFocusElement()))
                : "keyup" === n.type && this.data.set("behavior", []),
                e[0] &&
                  "keyup" === n.type &&
                  ("start" === (t = u.press(e))
                    ? this.toggleTools()
                    : "quit" === t
                    ? this.toggleTools("quit")
                    : "enter" === t
                    ? ((e = document.activeElement) && e.click(),
                      this.readFocusElement())
                    : "readScreen" === t
                    ? this.handleReadScreen()
                    : t &&
                      (this.data.set("quickType", t),
                      l.default.fire("type", null)));
            }),
            (i.prototype.readFocusElement = function () {
              this.setTimeout(
                "focusReader",
                function () {
                  l.default.fire("read", {
            ...
            (i.prototype.handleKeup = function () {
              this.data.set("quickType", "");
            }),
            (i.prototype.toggleTools = function (n) {
              this.data.get("show")
                ? (this.hideTools(), this.clearCompletely(n))
                : this.showTools();
            }),
            (i.prototype.clearCompletely = function (n) {
              if (n && "quit" === n) {
                (n = this.data.get("scaleDom")),
                  n.forEach(function (n) {
                    $(n)
                      .removeClass("aging-scale")
            ...
            (i.prototype.showTools = function () {
              ...
              n && n.fire("tts.close"),
                ...
                this.logSend("工具条展现");
              try {
                localStorage.getItem("agingTools") ||
                  localStorage.setItem("agingTools", "");
              } catch (n) {}
            }),
            (i.prototype.hideTools = function () {
              var n = this.data.get("from"),
                t = this.data.get("bigTextDom");
              $(this.data.get("rootDom")).removeClass("darkmode dark blue"),
                $("body").removeClass(
                  "aging-tools-gap darkmode dark blue aging-scale"
                ),
                this.data.set("show", !1),
                this.data.set("showArea", !1),
                t && t.css("padding-bottom", ""),
                "index" === n &&
                  ($("#bottom_layer").css("bottom", ""),
                  $("#s_side_wrapper").css("bottom", ""));
            }),
            (i.prototype.handleReadScreen = function () {
              var n = this.data.get("showArea"),
                t = this.data.get("bigTextDom");
              n &&
                ($("#bottom_layer").css("bottom", ""),
                t && t.css("padding-bottom", "")),
                this.data.set("showArea", !n);
            }),
            (i.prototype.addPageDescrib = function () {
              var n;
              document.querySelector("#aging-total-page") ||
                ((n = document.createElement("a")).setAttribute(
                  "id",
                  "aging-total-page"
                ),
                n.setAttribute("role", "pagedescription"),
                n.setAttribute(
                  "aria-label",
                  "欢迎进入 百度一下，你就知道，盲人用户进入读屏幕模式请按快捷键Ctrl加Alt加R；阅读详细操作说明请按快捷键Ctrl加Alt加问号键。"
                ),
      ...
      function (n, t, e) {
        ...
        var o,
          a = e(1),
          s = e(0),
          r = a.__importDefault(e(5)),
          l = a.__importDefault(e(31)),
          u = a.__importDefault(e(35)),
          h = a.__importDefault(e(6)),
          d = a.__importDefault(e(13)),
          e = a.__importDefault(e(43)),
          e =
            ((o = s.Component),
            a.__extends(i, o),
            (i.prototype.initData = function () {
            ...
            (i.prototype.fireQuickKeyUp = function () {
              this.fire("quickKeyUp", {});
            }),
            (i.prototype.logSend = function (n) {
              this.fire("logSend", n);
            }),
            (i.prototype.handleReading = function (n) {
              this.data.set("readText", n.val);
            }),
            (i.prototype.initStatus = function () {
              var n = this.data.get("statusList")[1];
              n[0] && this.setColor(n[0]),
                n[1] &&
                  1 != +n[1] &&
                  (this.data.set("enlargeChecked", !0), this.setScale(+n[1])),
                n[2] &&
                  "false" !== n[2] &&
                  (this.data.set("cursor", !1), this.handleCursor()),
                n[3] &&
                  "false" !== n[3] &&
                  this.data.set("crossEvent", "click");
            }),
            (i.prototype.initCrossEvent = function () {
              this.data.set("crossEvent", "");
            }),
            (i.prototype.initBigEvent = function () {
              this.data.set("bigTextEvent", "");
            }),
            (i.prototype.bindShortcutKey = function (n) {
              (n = n || this.data.get("quickType")),
                "cursor" === n
                  ...
                  ? this.handleColor()
                  : "enlarge" === n || "narrow" === n
                  ? this.handleScale("enlarge" === n ? n : "")
                  : "explain" === n
                  ? (window.location.href = this.data.get("explainUrl"))
                  : "reset" === n
                  ? this.handleReset()
                  : "cross" === n && this.data.set("crossEvent", "click");
            }),
            (i.prototype.handleReset = function (n) {
              this.handleColor("reset"),
                this.handleScale("reset"),
                this.handleCursor("reset"),
                this.data.set("crossEvent", "reset"),
                this.data.set("bigTextEvent", "reset");
              var t = h.default(this.data.get("statusList"), "reset", "");
              this.data.set("statusList", t);
              var e = this.ref("voice"),
                t = this.ref("text");
              e && e.resetAll && e.resetAll(),
                t && t.resetAll && t.resetAll(),
                n || this.logSend("重置");
            }),
            (i.prototype.handleColor = function (n) {
              var t = this.data.get("colorProps.type"),
                e = "";
              "reset" !== n &&
                (t ? "dark" === t && (e = "blue") : (e = "dark"),
                this.logSend("配色_" + e)),
                (t = h.default(this.data.get("statusList"), "color", e)),
                this.data.set("statusList", t),
                this.setColor(e);
            }),
            (i.prototype.setColor = function (n) {
              var t = this.data.get("rootDom"),
                e = $("body");
              this.data.set("colorProps.type", n),
                t &&
                  ((t = $(t)).removeClass("darkmode dark blue"),
                  e.removeClass("darkmode dark blue"),
                  n &&
                    (t.addClass("darkmode " + n), e.addClass("darkmode " + n)));
            }),
            (i.prototype.handleScale = function (n) {
              ...
              "reset" === n
                ...
                : n
                ? (2 > t && (t += 1),
                  this.data.set("enlargeChecked", !0),
                  this.logSend("放大"))
                : (t > 0 && --t, this.logSend("缩小")),
                (n = e[t]),
                (e = h.default(this.data.get("statusList"), "scale", n)),
                this.data.set("statusList", e),
                t || this.data.set("enlargeChecked", !1),
                this.setScale(n);
            }),
            (i.prototype.setScale = function (n) {
              var t,
                e = this,
                i = this.data.get("scaleDom");
              this.data.set("scale", n),
                0 < i.length &&
                  ((t = ""),
                    ...
                    (t = $(i)),
                      1 === n
                        ...
                        : t
                            ...
                            .addClass("aging-scale"),
                      e.fire("scale", { index: n });
                  }));
            }),
            (i.prototype.handleCursor = function (n) {
              ...
              t || "reset" === n
                ...
                : t ||
                  ...
                  (e = !0)),
                this.data.set("cursorChecked", e),
                this.data.set("cursor", e),
                (t = h.default(this.data.get("statusList"), "cursor", "" + e)),
                this.data.set("statusList", t),
                "reset" !== n &&
                  this.logSend(e ? "鼠标样式_添加" : "鼠标样式_移除");
            }),
            (i.prototype.handleQuit = function () {
              this.handleReset(!0),
                this.logSend("退出服务"),
                this.fire("quit", {});
            }),
            (i.prototype.handleChange = function (n) {
              var t = h.default(
                this.data.get("statusList"),
                "cross",
                "" + n.show
              );
              this.data.set("statusList", t),
                this.logSend(n.show ? "十字线_开" : "十字线_关");
            }),
            (i.prototype.handleAreaClick = function () {
              this.fire("readScreen", {}), this.logSend("读屏幕");
            }),
            (i.computed = {
              colorText: function () {
                var n = this.data.get("colorProps");
                return "dark" === n.type
                  ? "黑黄"
                  : "blue" === n.type
                  ? "蓝黄"
      ...
      function (n, t, e) {
        ...
        var o,
          ...
          a =
            ...
            (i.prototype.itemClk = function (n) {
              this.fire("click", n);
            }),
            (i.components = {}),
            i);
          ...
          e =
            ...
            (i.prototype.attached = function () {
              ...
              this.watch("eventStatus", function (e) {
                "reset" === e &&
                  (t.data.set("showCross", !1),
                  n.data.set("crossChecked", !1),
                  t.detachFunc(),
                  n.fire("reset", {})),
                  "click" === e &&
                    n.el &&
                    n.el.children &&
                    n.el.children[0] &&
                    (n.el.children[0].click(), n.fire("click", {}));
              });
            }),
            (i.prototype.getCrossPos = function (n) {
            ...
            (i.prototype.handleCross = function (n) {
              var t = this.data.get("showCross");
              t
                ? this.detachFunc()
                : (this.getCrossPos(n),
                  (n = this.getCrossPos.bind(this)),
                  this.data.set("posFunc", n),
                  document.addEventListener("mousemove", n)),
                this.data.set("crossChecked", !t),
                this.data.set("showCross", !t),
                this.fire("change", { show: !t });
            }),
            (i.prototype.detachFunc = function () {
              var n = this.data.get("posFunc");
              document.removeEventListener("mousemove", n);
            }),
            (i.components = { "a-item": e.default }),
            i);
        t.default = e;
      },
      function (n, t, e) {
      ...
      function (n, t, e) {
        ...
        var o,
          ...
          s = e(0),
          r = a.__importDefault(e(5)),
          l = a.__importDefault(e(42)),
          u = a.__importDefault(e(6)),
          h = a.__importDefault(e(7)),
          d = e(15),
          r =
            ((o = s.Component),
            a.__extends(i, o),
            (i.prototype.initData = function () {
              return {
                useVoice: !0,
                type: { onoff: "voiceOn", speed: "speed", mode: "pointread" },
                onlyOnoff: !1,
            ...
            (i.prototype.attached = function () {
              var n = this,
                t = "",
                e = this.data.get("disableVoice");
              try {
                var i = localStorage.getItem("agingTools");
                i && (t = i.split("_")[4]);
              } catch (e) {}
              (i = this.data.get("isReadScreen")),
                e || this.createAudio(),
                this.bindHandlerFun(),
                this.bindShortcutKey(),
                this.watch("quickType", function (t) {
                  n.bindShortcutKey(t), n.fire("quickKeyUp", {});
                }),
                this.reading(),
                i &&
                  this.watch("screenText", function (t) {
                    t && n.getReading(t);
                  }),
                "off" === t && this.data.set("type.onoff", "voiceOff"),
                this.watch("showStatus", function (e) {
                  if (e)
                    try {
                      var i,
                        o = localStorage.getItem("agingTools");
                      o &&
                        ((i = o.split("_")),
                        "off" === (t = i[4])
                          ? n.data.set("type.onoff", "voiceOff")
                          : n.data.set("type.onoff", "voiceOn"));
                    } catch (e) {}
                }),
                h.default.on("read", this.outterRead.bind(this));
            }),
            (i.prototype.outterRead = function (n) {
              "single" === n.type && n.target
                ? this.handlePoint(n)
                : "multi" === n.type && n.target && this.handleSeriesread(n);
            }),
            (i.prototype.bindShortcutKey = function (n) {
              (n = n || this.data.get("quickType")),
                "voiceSwitch" === n
            ...
            (i.prototype.createAudio = function () {
              var n = this,
                t = null;
              document.querySelector(".aging-audio")
                ? (t = document.querySelector(".aging-audio"))
                : (((t = new Audio()).className = "aging-audio"),
                  document.body.appendChild(t)),
                this.data.set("myAudio", t),
            ...
            (i.prototype.detached = function () {
              ...
              n && n.parentNode.removeChild(n),
                h.default.off("read", this.outterRead.bind(this)),
                $(document.body).off("click.audio");
            }),
            (i.prototype.resetAll = function () {
              this.setNewType("onoff", "voiceOn"),
                u.default(this.data.get("statusList"), "voice", ""),
                this.setNewType("speed", "speed"),
                this.setNewType("mode", "pointread"),
                this.reading();
            }),
            (i.prototype.clearHandler = function () {
            ...
            (i.prototype.bindHandlerFun = function () {
              this.data.set("pointFunc", this.handlePoint.bind(this)),
                this.data.set("seriesFunc", this.handleSeriesread.bind(this));
            }),
            (i.prototype.reading = function () {
              this.clearHandler();
            ...
            (i.prototype.handlePoint = function (n) {
              var t = this,
                e = t.data.get("timer"),
                i = t.data.get("from"),
              ...
              clearTimeout(e),
                (e = setTimeout(function () {
                  var e = $(n.target),
                    e = l.default(e, i);
                  e.val &&
                    (t.fire("getReadingText", { val: e.val }),
                    o || t.getReading(e.val));
                }, 50)),
                this.data.set("timer", e);
            }),
            (i.prototype.handleSeriesread = function (n) {
              var t = this,
                e = $(n.target),
                i = t.data.get("from"),
                o = t.data.get("timer"),
                a = this.data.get("isReading");
              clearTimeout(o),
                (o = setTimeout(
                  function () {
                    var o = $(n.target),
                      a = l.default(e, i),
                      s = l.default(o, i);
                    (e.attr("class") !== o.attr("class") && a.val !== s.val) ||
                      (s.val &&
                        (t.fire("getReadingText", { val: s.val }),
                        t.data.set("readTarget", s.target),
                        t.getReading(s.val)));
                  },
                  a ? 3e3 : 50
                )),
                this.data.set("timer", o);
            }),
            (i.prototype.showToast = function () {
              var n = $("body"),
                t = this.data.get("toastTimer");
              0 === $(".aging-toast").length &&
                n.append(
                  '<div class="aging-toast">读取失败，请重新放置鼠标</div>'
                ),
                clearTimeout(t),
                setTimeout(function () {
                  $(".aging-toast").remove();
            ...
            (i.prototype.seriesRead = function (n) {
              for (
                var t = null,
                  e = this.data.get("from"),
                  i = d.getNextReadNode(n),
                  t = l.default(i, e);
                !t.target && !t.val && i[0];

              )
                (i = d.getNextReadNode(i)), (t = l.default(i, e));
              i[0] &&
                (this.data.set("readTarget", i),
                t.val
                  ? (this.fire("getReadingText", { val: t.val }),
                    this.getReading(t.val))
                  : (i.hasClass("dustbin") &&
                      (i = i.parents(".s-news-item").next()),
                    this.fireReading(i)));
            }),
            (i.prototype.fireReading = function (n) {
              var t = this.data.get("from"),
                t = l.default(n, t);
              t.val &&
                (this.fire("getReadingText", { val: t.val }),
                this.data.set("readTarget", n),
                this.getReading(t.val));
            }),
            (i.prototype.getReading = function (n) {
              var t = this,
                e = this,
                i = e.data.get("voiceApi"),
              ...
              "voiceOff" === a ||
                ...
                $.ajax({
                  ...
                  scriptCharset: "utf-8",
                  success: function (n) {
                    var i = (n.data || {}).audio_list;
                    i && 0 !== i.length
                      ? ((o.src = i.shift()),
                        (n = e.data.get("type.speed")),
                        (o.playbackRate = "speed2" === n ? 1.25 : 1),
                        (i = e.test.bind(e, [o, i])),
                        $(o).off("ended"),
                        $(o).on("ended", i),
                        t.audioPlay(o),
                        t.data.set("isReading", !0),
                        t.data.set("myAudio", o))
                      : e.showToast();
                  },
                  error: function () {
                    e.showToast();
            ...
            (i.prototype.audioPlay = function (n) {
              (n = n.play()), n && n.catch(function () {});
            }),
            (i.prototype.test = function () {
              ...
              i && i.length
                ? ((i = i.shift()), (e.src = i), this.audioPlay(e))
                : ($(e).off("ended"),
                  this.data.set("isReading", !1),
                  "seriesread" !== o ||
                    ((o = this.data.get("readTarget")) && this.seriesRead(o)));
            }),
            (i.prototype.voiceOnOff = function () {
              var n;
              this.updateType("onoff", "voiceOn", "voiceOff"),
                "voiceOff" === this.data.get("type.onoff")
                  ? (u.default(this.data.get("statusList"), "voice", "off"),
                    ((n = this.data.get("myAudio")).src = ""),
                    this.data.set("myAudio", n))
                  : u.default(this.data.get("statusList"), "voice", ""),
                this.logSend(
                  "voiceOn" === this.data.get("type").onoff
                    ? "声音开"
                    : "声音关"
                );
            }),
            (i.prototype.judgeVoice = function () {
              this.data.get("type.onoff");
            }),
            (i.prototype.updateType = function (n, t, e) {
              var i = "",
                o = this.data.get("type." + n);
              return this.data.set("type." + n, (i = o === t ? e : t)), i;
            }),
            (i.prototype.setNewType = function (n, t) {
              this.data.get("type." + n) !== t && this.data.set("type." + n, t);
            }),
            (i.prototype.handleSpeed = function () {
              this.updateType("speed", "speed", "speed2"),
                this.logSend(
                  "speed2" === this.data.get("type").speed ? "语速快" : "语速"
                );
            }),
            (i.prototype.handleReadmode = function () {
              var n = "",
                n =
                  "pointread" ===
                  this.updateType("mode", "pointread", "seriesread")
                    ? "开启点读模式，请将鼠标移至需要阅读的位置"
                    : "开启连读模式，请将鼠标移至需要阅读的位置";
              this.getReading(n),
                this.reading(),
                this.logSend(
                  "pointread" === this.data.get("type").mode
                    ? "点读模式"
                    : "连读模式"
                );
            }),
            (i.components = { "a-item": r.default }),
            i);
        t.default = r;
      },
      function (n, t, e) {
        ...
        function r(n) {
          ...
          return (
            ...
            t.sort(function (n, t) {
              return (
                parseInt($(t).attr("tabindex") || 0, 10) -
                parseInt($(n).attr("tabindex") || 0, 10)
              );
            }),
            t
          );
        ...
        (t.__esModule = !0),
          (t.interveneFocus = t.addFilter = t.getNextReadNode = void 0);
        var u = e(1),
          h = [],
          d = [],
          c = [];
        d.push(function () {
          ...
          /s-tab-item/.test(n.className) &&
            /s-tab-more/.test(n.className) &&
            /更多/.test(n.innerText) &&
            i(document.querySelector("#content_left"));
        }),
          d.push(function () {
            var n = document.activeElement,
              t = document.querySelector("#rs_new table tbody");
            t && o(t) === n && i(document.querySelector("#content_right"));
          }),
          d.push(function () {
            var n = document.activeElement,
              t = document.querySelector("#content_right");
            t &&
              o(t) === n &&
              i(
                document.querySelector("#page a") ||
                  document.querySelector("#help a")
              );
          }),
          c.push(function () {
            var n = document.activeElement,
              t = document.querySelector("#page a");
            t && t === n && i(o(document.querySelector("#content_right")));
          }),
          c.push(function () {
            var n = document.activeElement,
              t = a(document.querySelector("#content_right"));
            t && t === n && i(o(document.querySelector("#rs_new table tbody")));
          }),
          c.push(function () {
            var n = document.activeElement,
              t = a(document.querySelector("#content_left"));
            t &&
              t === n &&
              i(document.querySelector("a.s-tab-item.s-tab-more"));
          }),
          h.push(function (n) {
          ...
          h.push(function (n) {
            ...
            n.children().each(function (n, e) {
              return (t += e.innerText);
            });
            var e =
                n.text().trim() &&
                n.text().trim() !== n.children().text().trim(),
              n = n[0] && n[0].innerText.trim() && n[0].innerText.trim() !== t;
            return e && n;
          }),
          (t.addFilter = function (n) {
            h = u.__spreadArray(u.__spreadArray([], h), n);
          }),
          (t.getNextReadNode = function g(n) {
            var t,
              e,
              i = null,
              i =
                n.children()[0] && "none" !== n.css("display")
                  ? ((t = r((t = n).children())), $(t[0]))
                  : l(n)[0]
                  ? l(n)
                  : ((n = (function (n) {
                      for (; n.parent()[0] && !l(n.parent())[0]; )
                        n = n.parent();
                      return n;
                    })(n)),
                    l(n.parent()));
          ...
          l =
            ...
            (i.prototype.attached = function () {
              ...
              try {
                ...
                e &&
                  e.split("_")[5] &&
                  (this.data.set("showPopup", !0),
                  i && i.css("padding-bottom", "160px"),
                  "index" === t &&
            ...
            (i.prototype.bindShortcutKey = function (n) {
              "bigTextSwitch" === (n || this.data.get("quickType")) &&
                this.handleBigText();
            }),
            (i.prototype.setBoard = function (n, t) {
              var e = this.data.get("from"),
                i = this.data.get("statusList");
              return n
                ? (t && t.css("padding-bottom", "160px"),
                  "index" === e &&
                    ($("#bottom_layer").css("bottom", "160px"),
                    $("#s_side_wrapper").css("bottom", "216px")),
                  u.default(i, "bigText", "1"))
                : (t && t.css("padding-bottom", ""),
                  "index" === e &&
                    ($("#bottom_layer").css("bottom", ""),
                    $("#s_side_wrapper").css("bottom", "")),
            ...
            (i.prototype.handleBigText = function () {
              var n = this.data.get("showPopup"),
                t = this.data.get("bigTextDom"),
                t = this.setBoard(!n, t);
              this.data.set("statusList", t),
                this.data.set("showPopup", !n),
                this.logSend(n ? "大字幕_关" : "大字幕_开");
            }),
            (i.prototype.logSend = function (n) {
              this.fire("logSend", n);
            }),
      ...
      function (n, t, e) {
        var i = e(2),
          ...
          a = e(49),
          s = e(18).default;
        (n.exports = e(18)), (n.exports.default = i(s, a, o));
      },
      function (n, t, e) {
        "use strict";
        function i() {
          ...
          a =
            ...
            (i.prototype.initData = function () {
              return {
                ...
                showType: "",
                readText:
                  "测试: 网址之家是好用、简单的中文上网导航,汇集优秀的网站及资源。提供搜索、天气预报、实用工具等服务,及时收录影视、音乐、小说、游戏、购物等分类的网址和内容,让您的网络生活更简单精彩。测试: 网址之家是好用、简单的中文上网导航,汇集优秀的网站及资源。提供搜索、天气预报、实用工具等服务,及时收录影视、音乐、小说、游戏、购物等分类的网址和内容,让您的网络生活更简单精彩。测试: 网址之家是好用、简单的中文上网导航,汇集优秀的网站及资源。提供搜索、天气预报、实用工具等服务,及时收录影视、音乐、小说、游戏、购物等分类的网址和内容,让您的网络生活更简单精彩。",
                textPinyinStr: "",
                displayFantiText: "",
                barTop: 0,
                fantiType: "繁体",
            ...
            (i.prototype.attached = function () {
              var n = this,
                t = this,
                e = this.ref("scrollArea"),
                i = this.ref("scrollInner");
              this.data.set("displayFantiText", this.data.get("readText")),
                ...
                e.addEventListener("scroll", function (n) {
                  n.stopPropagation(),
                    n.preventDefault(),
                    (n = $(e).scrollTop() / ($(i).height() - 124)),
                    (n = Math.floor(80 * n)),
                    t.data.set("barTop", n);
                }),
                this.watch("readText", function (t) {
                  var e = n.data.get("showType");
                  "pinyin" === e
                    ? n.usePinyin()
                    : "fanti" === e
                    ? n.useFanti("fanti")
                    : n.data.set("displayFantiText", t),
                    n.nextTick(function () {
                      120 < $(i).height()
                        ? n.data.set("showBar", !0)
                        : n.data.set("showBar", !1);
                    });
                });
            }),
            (i.prototype.logSend = function (n) {
            ...
            (i.prototype.usePinyin = function () {
              this.data.set("displayFantiText", "");
              for (
                var n = this.data.get("readText"), t = [], e = 0;
                e < n.length;
                e++
              ) {
                var i = n.charAt(e),
                  o = r.pinyin[i] || i;
                t.push({ text: i, char: o });
              }
              this.data.set("displayPinyinText", t),
                this.data.set("showType", "pinyin"),
                this.logSend("使用拼音");
            }),
            (i.prototype.useFanti = function (n) {
              var t = this.data.get("readText"),
                e = this.data.get("fantiType");
              if (
                (this.logSend("使用" + (e = "fanti" === n ? "繁体" : e)),
                "繁体" === e)
              ) {
                ...
                this.data.set("displayFantiText", i),
                  this.data.set("showType", "fanti");
              } else
                (e = "繁体"),
                  this.data.set("showType", ""),
                  this.data.set("displayFantiText", t);
      ...
      function (n, t, e) {
        ...
        var o,
          ...
          s = e(0),
          r = a.__importDefault(e(5)),
          l = a.__importDefault(e(13)),
          u = a.__importDefault(e(17)),
          h = a.__importDefault(e(7)),
          u =
            ((o = s.Component),
            a.__extends(i, o),
            (i.prototype.initData = function () {
              return {
                areaQuick: ["Ctrl+1", "Ctrl+2", "Ctrl+3", "Ctrl+4"],
                explainUrl: "https://www.baidu.com/search/aging-tools.html",
                useNav: !1,
                curView: 0,
                curView2: 0,
            ...
            (i.prototype.attached = function () {
              ...
              n.forEach(function (n) {
                ...
                (t +=
                  ...
                  "个服务区，共计" +
                  e +
                  "个区域组成，操作帮助请按Ctrl 加 Alt 加 问号键"),
                this.data.set("screenText", t),
                this.data.set("readText", t),
                this.handleBottomPop(),
                h.default.on("exitRead", this.handleAreaClick.bind(this));
            }),
            (i.prototype.detached = function () {
            ...
            (i.prototype.handleNav = function (n) {
              var t,
                e = $(window),
                i = [
                  "#s-top-left",
                ...
                o = this.data.get("curView3"),
                a =
                  "您已进入导航区，本区域有3个网站导航区，共计3个区域组成，操作帮助按下tab键浏览信息",
                s = 0;
              (s = o < i.length - 1 ? o + 1 : 0) &&
                ...
                (t = $(i[s]).offset().top),
                e.scrollTop((t -= 70)),
                this.data.set("curView", s),
                this.data.set("screenText", a),
                this.data.set("readText", a),
                this.logSend("导航区" + n);
            }),
            (i.prototype.handleView = function (n) {
              var t,
                e = this.data.get("from"),
                i = $(window),
                o = [],
                a = 0,
                s = this.data.get("curView"),
                r = "您已进入视窗区，本区域有";
              "index" === e
                ? ((o = ["#s-hotsearch-wrapper", ".s-menu-item[data-id=2]"]),
                  (r +=
                    "1个推荐视窗区，共计1个区域组成，操作帮助按下tab键浏览信息"))
                : ((o = [
                    "#content_left",
                    "#con-ar",
                  ...
                  (r +=
                    "1个结果视窗区，3个推荐视窗区，共计4个区域组成，操作帮助按下tab键浏览信息")),
                (a = s < o.length - 1 ? s + 1 : 0),
                $(o[a]).length &&
                  ((t = $(o[a]).offset().top),
                  i.scrollTop((t -= 70)),
                  this.data.set("curView", a)),
                this.data.set("screenText", r),
                this.data.set("readText", r),
                this.logSend("视窗区" + n);
            }),
            (i.prototype.handleOperation = function (n) {
              var t = $(window),
                e = [],
                i = "您已进入交互区，本区域有";
              "index" === this.data.get("from")
                ? ((e = ["#head"]),
                  (i +=
                    "1个搜索交互区，共计1个区域组成，操作帮助按下tab键浏览信息"))
                : ((e = ["#head", "#s_tab", "#page"]),
                  (i +=
                    "2个搜索交互区，1个换页交互区，共计3个区域组成，操作帮助按下tab键浏览信息"));
              var o = this.data.get("curView1"),
                a = 0,
                a = o < e.length - 1 ? o + 1 : 0,
                s = $(e[a]).offset().top;
              t.scrollTop((s -= 70)),
                this.data.set("curView1", a),
                this.data.set("screenText", i),
                this.data.set("readText", i),
                this.logSend("交互区" + n);
            }),
            (i.prototype.handleService = function (n) {
              var t = this.data.get("from"),
                e = $(window),
                i = "您已进入服务区，本区域有",
                o = [];
              "index" === t
                ? ((o = ["#u1"]),
                  (i +=
                    "1个版本服务区，共计1个区域组成，操作帮助按下tab键浏览信息"))
                : ((o = ["#u", "#foot"]),
                  (i +=
                    "1个版本服务区，1个帮助服务区，共计2个区域组成，操作帮助按下tab键浏览信息"));
              var a = this.data.get("curView2"),
                t = 0,
                t = a < o.length - 1 ? a + 1 : 0,
                s = $(o[t]).offset().top;
              e.scrollTop((s -= 70)),
                this.data.set("curView2", t),
                this.data.set("screenText", i),
                this.data.set("readText", i),
                this.logSend("服务区" + n);
            }),
            ...
            (i.prototype.handleBottomPop = function () {
              var n = this.data.get("bigTextDom"),
                t = this.data.get("from");
              n && n.css("padding-bottom", "160px"),
                "index" === t &&
                  ($("#bottom_layer").css("bottom", "160px"),
                  $("#s_side_wrapper").css("bottom", "216px"));
            }),
            ...
            (i.components = {
              "a-item": r.default,
              "a-voice-item": l.default,
              "a-bottom-popup": u.default,
            }),
            i);
        t.default = u;
      },
      ...
      function (n, t, e) {
        var i = e(22);
        (i = "string" == typeof i ? [[n.i, i, ""]] : i).locals &&
          (n.exports = i.locals),
          e(4).default("0a9649d4", i, !0, {
      ...
      function (n, t, e) {
        var i = e(2),
          ...
          a = e(38),
          s = e(12).default;
        (n.exports = e(12)), (n.exports.default = i(s, a, o));
      },
      function (n, t, e) {
        var i = e(37);
        (i = "string" == typeof i ? [[n.i, i, ""]] : i).locals &&
          (n.exports = i.locals),
          e(4).default("52a745b0", i, !0, {
            attributes: { "data-for": "result" },
            runAsProduction: !0,
          });
      },
            ...
            ? ("index" !== t
                ? function (n) {
                    ...
                    if (
                      5 < n.find("a").length ||
                      3 < n.find("div").length ||
                      3 < n.find("span").length ||
                      5 < n.find("input").length ||
                      (n.children()[0] && "HTML" === n.children()[0].tagName) ||
                      n.hasClass("c-icon") ||
                      n.attr("aria-hidden") ||
                      "none" === n.css("display")
                    )
                    ...
                    if (
                      n.attr("aria-label") ||
                      (n.parents("[aria-label]").length &&
                        n.parents("[aria-label]").attr("aria-label"))
                    ) {
                      var o = "";
                      return {
                        val: (o = (
                          n.attr("aria-label") ? n : n.parents("[aria-label]")
                        ).attr("aria-label")),
                        target: n,
                      };
                    }
                    if (n.parents("[tpl=right_toplist1]").length) {
                      var a =
                        n.attr("title") || n.find("[title]").attr("title");
                      if (a) return { val: "热搜：" + a, target: n };
                      if (n.children().length < 1)
                        return { val: n.text(), target: n };
                    } else {
                      if (n.attr("title"))
                        return { val: n.attr("title"), target: n };
                      ...
                      if (
                        ...
                        if (
                          ...
                          a.attr("href")
                            ? ((i = "链接："),
                              a.hasClass("c-title") || a.hasClass("t")
                                ? (i = "标题链接：")
                                : a.parent().length &&
                                  a.parent().hasClass("s_tab_inner") &&
                                  (i = "导航："))
                            : "button" === a.attr("role") && (i = "按钮："),
                          a.find("[aria-label]").length &&
                            a.find("[aria-label]").attr("aria-label"))
                        ) {
                          var s = a.find("[aria-label]");
                          i = "";
                          for (var r = 0; r < s.lenth; r++)
                            t += s.eq(r).attr("aria-label");
                        } else if (a.attr("title"))
                          a.hasClass("c-img") && (i = "图片："),
                            (t = a.attr("title"));
                        else if (a.find("span").length && a.find("span").text())
                          t = a.find("span").text();
                        else {
                          if (!a.text()) return { val: "", link: a };
                          var l = n.find(".c-icon"),
                            o = a.text();
                          l.length && (o = o.replace(l.text(), "")), (t = o);
                        }
                        return { val: i + t, target: a };
                      }
                      if ("EM" === n[0].tagName)
                        return { val: n.parent().text(), target: n };
                      if (
                        n.hasClass("c-abstract") ||
                        0 === n.children("div").length ||
                        n.text()
                      )
                        return (
                          (l = n.find(".c-icon")),
                          (o = n.text()),
                          {
                            val: (o = l.length ? o.replace(l.text(), "") : o),
                            target: n,
                          }
                        );
                    }
                ...
                : function (n) {
                    ...
                    if (
                      (n.children()[0] && "HTML" === n.children()[0].tagName) ||
                      "head" === n.attr("id") ||
                      "head_wrapper" === n.attr("id") ||
                      5 < n.find("a").length ||
                      5 < n.find("div").length ||
                      n.hasClass("aging-popup") ||
                      n.parents().hasClass("aging-popup") ||
                      n.hasClass("c-icon") ||
                      n.attr("aria-hidden") ||
                      "none" === n.css("display")
                    )
                    ...
                    if (
                      n.attr("aria-label") ||
                      (n.parents().length && n.parents("[aria-label]").length)
                    )
                      return {
                        val: (n.attr("aria-label")
                          ? n
                          : n.parents("[aria-label]")
                        ).attr("aria-label"),
                        target: n,
                      };
                    if (
                      n.parents("[tpl=hot-news]").length ||
                      n.parents("#s-hotsearch-wrapper").length
                    ) {
                      ...
                      if (n.text())
                        return {
                          val:
                            (n.hasClass("title-content-title")
                              ? "热搜："
                              : "") + n.text(),
                          target: n,
                        };
                      ...
                      if (
                        n.find("a").length ||
                        (n.parent()[0] && "A" === n.parent()[0].tagName) ||
                        (n[0] && "A" === n[0].tagName)
                      ) {
                        var o = n;
                        return (
                          ...
                          o.attr("href")
                            ? (i = "链接：")
                            : "button" === o.attr("role") && (i = "按钮："),
                          (t = o.attr("title")
                            ? (o.hasClass("c-img") && (i = "图片："),
                              o.attr("title"))
                            : (o.find("span").length
                                ? o.find("span")
                                : o
                      ...
                      if (
                        ...
                        return { val: n.text(), target: n };
                      if ("su" === n.attr("id"))
                        return { val: "百度一下：搜索提交按钮", target: n };
                      if (n.text()) return { val: n.text(), target: n };
                    }
                    return e;
                  })(n)
            : e;
      ...
      function (n) {
        n.exports =
          ' <div class="{{$style[\'big-wrap\']}}"> <a-item text="大字幕" wide class="{{$style.item}}" checked="{{ showPopup }}" type="bigText" on-click="handleBigText" key="大字幕{{showPopup ? \'关闭\' : \'开启\'}} Ctrl 加 Alt 加 B"> </a-item> <a-bottom-popup s-if="showPopup" readText="{{ readText }}" on-close="handleClose" on-logSend="logSend"></a-bottom-popup> </div> ';
      },
      function (n, t, e) {
        var i = e(48);
        (i = "string" == typeof i ? [[n.i, i, ""]] : i).locals &&
          (n.exports = i.locals),
          e(4).default("4c9cf4ac", i, !0, {
            attributes: { "data-for": "result" },
            runAsProduction: !0,
          });
      },
      ...
      function (n, t) {
        "use strict";
        (t.__esModule = !0), (t.changeFocus = t.press = void 0);
        var e = {
          69: "quit",
          77: "cursor",
          78: "cross",
        ...
        (t.press = function (n) {
          var t,
            i,
            o =
              ((t = (s = n).some(function (n) {
                return 18 === n;
              })),
              (o = s.some(function (n) {
                return 17 === n;
              })),
              (s = (i = s.filter(function (n) {
                return 17 !== n && 18 !== n;
              })).every(function (n) {
                return n === i[0];
              })),
              t && o && i[0] && s ? i[0] : void 0),
            a = n,
            s = 1 === a.length,
            n = a.every(function (n) {
              return n === a[0];
            });
          return o ? e[o] : (s || n) && 13 === a[0] ? "enter" : void 0;
        }),
          (t.changeFocus = function (n) {
      ...
      function (n, t, e) {
        var i = e(2),
          ...
          a = e(56),
          s = e(19).default;
        (n.exports = e(19)), (n.exports.default = i(s, a, o));
      },
      function (n, t, e) {
        var i = e(55);
        (i = "string" == typeof i ? [[n.i, i, ""]] : i).locals &&
          (n.exports = i.locals),
          e(4).default("a6427286", i, !0, {
            attributes: { "data-for": "result" },
            runAsProduction: !0,
          });
      },
  ...
  define(
    ...
    ["@baidu/aging-tools-pc/dist/index"],
    function (n) {
      return n;
    }
  );
