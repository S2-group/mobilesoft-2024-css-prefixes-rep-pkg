  ...
  !(function (e, t) {
    ...
    return (function (e) {
      ...
      function (e, t, n) {
        ...
        function c(e) {
          b &&
            (document.addEventListener(g, e), document.addEventListener(w, e));
        }
        function d(e) {
        ...
        (t["default"] = {
          initException: function () {
            (this.exceptionDim = null),
              (this.exceptionInfo = {}),
              (this.onerrorCb = o.bind(this));
          },
          startJsExceptionLog: function (e, t) {
            (this.exceptionInfo = (0, i.assign)({}, e)),
              (this.exceptionDim = (0, i.assign)({}, t)),
        ...
        (t["default"] = {
          sendBaseDispLog: function (e, t, n) {
            var i = document.documentElement,
              r = {
                size: {
                  doc: { w: i.scrollWidth, h: i.scrollHeight },
                  wind: { w: i.clientWidth, h: i.clientHeight },
                  scr: { w: screen.width, h: screen.height },
                },
                dpr: window.devicePixelRatio || 1,
              };
            e && (r = (0, o.assign)(r, e)),
              this.send("disp_comm", r, t, null, n);
          },
          sendDispLog: function (e, t, n) {
            var i = void 0;
            (i = e instanceof Array ? e : (0, o.assign)({}, e)),
              this.send("disp_content", i, t, null, n);
          },
        }),
          (e.exports = t["default"]);
      },
        ...
        (t["default"] = {
          sendBasePfLog: function () {
            var e =
              ...
              g = b.whiteScreenTime,
              w = b.firstScreenTime;
            g && (v = (0, o.assign)(v, { wst: g - r })),
              w && (v = (0, o.assign)(v, { fst: w - r })),
              (v = (0, o.assign)(v, e)),
              this.send("pf_comm", v, t, null, n);
          },
          sendPfLog: function () {
            var e =
                arguments.length > 0 && void 0 !== arguments[0]
      ...
      function (e, t, n) {
        ...
        "http:" === location.protocol &&
          (a = "http://sestat.baidu.com/webb.gif");
        var u = "https://sp1.baidu.com/5b1ZeDe5KgQFm2e88IuM_a/mwb2.gif";
        "http:" === location.protocol &&
          (u = "http://sestat.baidu.com/mwb2.gif");
        var c = {
            time: 1,
            ia: 1,
            disp_comm: 1,
          ...
          d = (function () {
            function e(t) {
              ...
              this.validateOptions(t),
                ...
                this.options.sample &&
                  (this.options.curSample =
                    Math.random() < this.options.sample ? 1 : 0),
            ...
            return (
              r(e, [
                  ...
                  value: function () {
                    ...
                    Object.keys(this.options).forEach(function (t) {
                      ...
                      n &&
                        n.sample &&
                        !n.curSample &&
                        (e.options[t].curSample =
                          Math.random() < n.sample ? 1 : 0);
                    });
                  },
                },
                {
                ...
                },
                {
                  key: "updateOption",
                  value: function (e) {
                    (this.options = (0, s.extend)(this.options, e)),
                      this.updateCurSample();
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (!t) return 0;
                    return "sample" in t
                      ? "eachreq" === t.sampleType
                        ? t.sample && Math.random() <= t.sample
                          ? 1
                          : 0
                        : t.curSample
                      : "eachreq" === this.options.sampleType
                      ? this.options.sample &&
                        Math.random() <= this.options.sample
                        ? 1
                        : 0
                      : this.options.curSample;
                  },
                },
                {
                  ...
                  value: function (e) {
                    var t = this.options;
                    return (t[e] && t[e].logHost) || t.logHost
                      ? t[e] && t[e].logHost
                        ? t[e].logHost
                        : t.logHost
                      : 2 === c[e]
                    ...
                    if (this.hitSample(e)) {
                      ...
                      (u.onload = function (e) {
                        ...
                        (u.onerror = function (e) {
                          o &&
                            o.errorCb &&
                            "function" == typeof o.errorCb &&
                            o.errorCb(e),
                            delete window[a];
                        }),
                        (u.src =
                          this.getLogHost(e) + "?" + (0, s.stringify)(r));
                    }
                  },
                },
                {
                  ...
                  value: function (e, t, n, o) {
                    if (this.hitSample(e)) {
                      ...
                      if (
                        ...
                        navigator.sendBeacon(
                          this.getLogHost(e) + "?" + (0, s.stringify)(i)
                        ) || this.send(e, t, n);
      ...
      function (e, t, n) {
        ...
        var i = n(1),
          ...
          h = o(m),
          y = n(0);
        (0, y.extend)(h["default"].prototype, r["default"]),
          (0, y.extend)(h["default"].prototype, a["default"]),
          (0, y.extend)(h["default"].prototype, c["default"]),
          (0, y.extend)(h["default"].prototype, l["default"]),
          (0, y.extend)(h["default"].prototype, f["default"]),
          (t["default"] = h["default"]),
          (e.exports = t["default"]);
      },
    ]);
...
var params = {
  ...
  curcardtab:
    $("#s_content_" + s_session.curmod + " " + ".s-xmancard").attr(
      "data-curtab"
    ) || "",
  _r: Math.random(),
};
...
F.addLog("superman:superuijs/component", { skinClick: "5100000001" });
...
F.addLog("superman:aging-tools", {
  ...
  new_aria_script_error: "5100000000",
  new_aria_script_load: "5100000000",
...
F.module("superman:lib/carditem_log", function (require, exports, ctx) {
  ...
  var buildLogParam = function (node) {
    ...
    extra = "";
    while (
      curNode.attr("data-rid") == undefined &&
      curNode.attr("id") != "s_ctner_contents"
    ) {
      if (curNode.attr("data-click") != undefined) {
        ...
        if (cType == "log_link") {
          if (
            curNode[0] &&
            curNode[0].nodeName &&
            curNode[0].nodeName.toLowerCase() == "a"
          ) {
            title =
              $.trim(curNode.attr("data-title")) ||
              $.trim(curNode.attr("title")) ||
              $.trim(curNode.text());
            var tmpurl = $.trim(curNode.attr("href"));
            if (
              !tmpurl.indexOf("#") == 0 &&
              !tmpurl.indexOf("javascript") == 0
            ) {
              url = tmpurl;
            }
          }
...
F.module("ps/log", function (require, exports, ctx) {
  ...
  var _MouseDown = function (e) {
    ...
    if (obj.tagName === "A") {
      ...
      var url = obj.href;
      if (txt in keyMap) {
        ctx.fire("categoryClick", { category: keyMap[txt], url: url });
      } else if (txt === s_session.username) {
        ctx.fire("categoryClick", { category: "username" });
      }
    }
    return false;
  };
...
F.addLog("superman:ps/sindex", { hwInput: "1100000900" });
  ...
  exports.init = function () {
    ...
    $(window).on("swap_end", function () {
      if (s_session.searchLogSend == 0) {
        ...
        var personalData = bds.comm.personalData;
        ctx.fire("searchBtnClick", {
          opType: "click",
          openMode: "current",
          wd: encodeURIComponent($("#kw").val()),
          isSkin: !!(personalData && personalData.skinUrl),
        });
      }
    });
    $(window)
    ...
    logoArea &&
      $(logoArea).bind("click", function (e) {
        ctx.fire("psLogoClick", {
          isFesBg: s_session.userTips.skinLogoHasSkined ? "1" : "0",
        });
      });
    wordLink &&
      $(wordLink).bind("click", function (e) {
        ctx.fire("psWorkLnkClick");
      });
  };
  exports.fire = function () {
    ctx.fire("hwInput", { clickType: "handWriteInput" });
  };
  function countStay() {
    var times = 0;
    var logInterval = setInterval(function () {
      ...
      ctx.fire("stayLog", { times: 10 });
    }, 1e4);
  }
  var psforie6resize = function () {
    $("#s_pss_guide").css(
      "width",
      document.body.clientWidth <= 958 ? "958px" : "100%"
    );
  };
  function _noskinbind($k) {
    ...
    return function ($k, bind) {
      if (!bind) {
        ...
        $k.unbind("focus", emitFo)
          .unbind("blur", emitBl)
          .unbind("mouseover", emitMv)
          .unbind("mouseout", emitMu);
    ...
    if (suggestion && suggestion.q && suggestion.p) {
      ...
      if (!(temp_sugs[suggestion.q] && temp_sugs[suggestion.p])) {
        ...
        for (var i = 0, f = 0; i < suggestions.length; i++) {
          if (
            suggestion.q == suggestions[i].q &&
            suggestion.p == suggestions[i].p
          ) {
            f = 1;
            break;
          }
      ...
      if (temp_sugs[suggestion.q] == undefined) {
        ...
        for (
          var j = 0, f = 0, len = temp_sugs[suggestion.q].length;
          j < len;
          j++
        ) {
          if (
            temp_sugs[suggestion.q][j].p == suggestion.p ||
            temp_sugs[suggestion.q][j].q == suggestion.q
          ) {
            f = 1;
            break;
          }
      ...
      if (temp_sugs[suggestion.p] == undefined) {
        ...
        for (
          var j = 0, f = 0, len = temp_sugs[suggestion.p].length;
          j < len;
          j++
        ) {
...
bds.se.sugsync = function () {
  ...
  var rsv_sug1 = 0,
    ...
    rsv_timer = null;
  var isIE =
    /msie (\d+)/i.test(navigator.userAgent) && !window.opera
      ? parseInt(RegExp.$1)
      : 0;
  ...
  var Inpt = (function () {
    ...
    function addInputTime() {
      addTj({ inputT: sugT > 0 ? new Date().getTime() - sugT : 0 });
    }
    function mousedown() {
      if (beforeStart) {
        Inpt.dm({ type: "start" });
    ...
    function keydown(e) {
      ...
      if (e.keyCode == 9 || e.keyCode == 27) {
        Inpt.dm({ type: "hide_div" });
      }
      if (e.keyCode == 13 && window.opera) {
        stopDefault(e);
        Inpt.dm({ type: "key_enter" });
      }
      ...
      if (div.style.display != "none") {
        ...
        if (e.keyCode == 40) {
          Inpt.dm({ type: "key_down" });
        }
      } else {
        if (e.keyCode == 38 || e.keyCode == 40) {
          Inpt.dm({ type: "need_data", wd: ipt.value });
        }
      }
    }
    function circle() {
      ...
      if (
        ...
        nowValue != "" &&
        nowValue != keyValue &&
        nowValue != mouseOverValue
      ) {
        if (requestTimer == 0) {
          requestTimer = setTimeout(function () {
            Inpt.dm({ type: "need_data", wd: nowValue });
          }, 100);
        }
      } else {
  ...
  var Sdiv = (function () {
    ...
    function changeData(data) {
      ...
      if (
        !bds.se.sugStorage.isSupport() ||
        !navigator.cookieEnabled ||
        (!!/\bsugstore=(\d)/.exec(document.cookie) &&
    ...
    function draw() {
      ...
      for (var i = 0, l = dataArray.length; i < l; i++) {
        ...
        if (dataArray[i].from == 1) {
          str =
            '<u class="sug_del" title="如您不需要此搜索历史提示，&#13;可在右上角搜索设置中关闭">删除</u>' +
            str;
      ...
      for (var i = 0; i < u.length; i++) {
        u[i].onclick = function (e) {
          ...
          img.src =
            $.url.escapeSSL("http://sclick.baidu.com/w.gif?q=") +
            encodeURIComponent(dataArray[selected].value) +
            "&fm=beha&rsv_sug=del&rsv_sid=11&t=" +
            new Date().getTime() +
    ...
    function keyup() {
      ...
      ct();
      if (selected == 0) {
        Sdiv.dm({ type: "key_select", selected: "" });
        G("kw").value = oq;
        selected--;
        rmTj({
          oq: oq,
        ...
        tr.className = "mo";
        Sdiv.dm({ type: "key_select", selected: dataArray[selected].value });
  ...
  var Data = (function () {
    ...
    function processData(word) {
      if (typeof dataObj[word] == "undefined") {
        Data.dm({ type: "request_data", wd: word });
      } else {
        Data.dm({ type: "give_data", data: dataObj[word] });
      }
    }
    function addData(d) {
      dataObj[d.q] = d;
      Data.dm({ type: "give_data", data: dataObj[d.q] });
    }
  ...
  var Request = (function () {
    ...
    function getDataScript(wd) {
      ...
      dataElm.src =
        ...
        "&p=" +
        cookieSwitch +
        "&cb=window.bdsug.sug&from=superpage" +
        "&t=" +
        new Date().getTime();
    ...
    function getSug() {
      var p =
        navigator.cookieEnabled && /sug=(\d)/.test(document.cookie)
          ? RegExp.$1
          : 3;
      Cookie.dm({ type: "give_cookie", sug: p });
    }
    return MessageDispatcher.ini({
      rm: function (evtObj) {
        switch (evtObj.type) {
  ...
  var GlobalCtrl = (function () {
    ...
    function listenZoom() {
      if (div.offsetWidth != 0 && ipt.offsetWidth != div.offsetWidth) {
        GlobalCtrl.dm({ type: "need_resize" });
      }
    }
    function createDiv() {
      div = C("DIV");
    ...
    function docMouseDown(e) {
      ...
      GlobalCtrl.dm({ type: "mousedown_other" });
    }
    function windowBlur() {
      GlobalCtrl.dm({ type: "window_blur" });
    }
    function initi() {
      var dI = "#" + div.id;
      var cssBuf = [];
      GlobalCtrl.dm({ type: "div_ready", sdiv: div, frm: ie6iframe });
      setInterval(listenZoom, 100);
      addEvent(document, "mousedown", docMouseDown);
      addEvent(window, "blur", windowBlur);
      cssBuf.push(
        dI + "{border:1px solid #817F82;position:absolute;top:32px;left:0}"
      );
      cssBuf.push(dI + " table{width:100%;background:#fff;cursor:default}");
      cssBuf.push(
        dI +
          " td{color:#000;font:14px arial;height:25px;line-height:25px;padding:0 8px}"
      );
      ...
      cssBuf.push(
        dI + " td p{font-size:14px;font-weight:bold;padding-left:20px}"
      );
      cssBuf.push(
...
F.module("ps/sug", function (require, exports, ctx) {
  ...
  exports.pssubmit = function () {
    var S = ctx.base;
    var satag = s_session.userTips.isNewTabSearch || "0";
    if (satag === "0") {
    ...
    var personalData = bds.comm.personalData;
    var isSkin = !!(personalData && personalData.skinUrl);
    if (
      satag !== "0" &&
      $("#kw")[0] &&
...
$(window).on("load", function () {
  ...
  if (
    ua.indexOf("msie") >= 0 ||
    new RegExp("trident(.*)rv.(\\d+)\\.(\\d+)").test(ua)
  ) {
    isIE = true;
  }
...
$(document).ready(function () {
    ...
    if (Math.random() * 100 < 1 && $.browser.edge) {
      window.testedge = function (fn) {
        ...
        var src =
          ...
          s_session.logPortrait +
          "&logactid=9000500000&health=" +
          health +
          "&t=" +
          +new Date();
  ...
  if ($.browser.chrome && $.browser.chrome === 37) {
    if (window.navigator.appVersion.indexOf("Windows NT 6.1") > -1) {
      $("#kw").css({ "font-family": "Microsoft Yahei,STHeiti" });
    }
  }
  ...
  $(window).bind("load", function () {
    ...
    require(["superman/components/ai-talk-switch"], function (module) {
      var AiTalkSwitch = module.AiTalkSwitch;
      var aiTalkSwitch = new AiTalkSwitch(window.require);
      $(window).on("index_off", function () {
        aiTalkSwitch.destroy();
      });
    });
  ...
  function _initLoadModel() {
    ...
    function handleResult(result) {
      ...
      if (+result.errno === 0 && result.data) {
        result.data.cityCode = result.cityCode;
  ...
  if (
    location.href.indexOf("frm=resultPage") > -1 &&
    location.href.indexOf("showType=showSkin") > -1
  ) {
...
F.module("superman:page/scroll", function (require, exports, ctx) {
  ...
  function handleSDown() {
    ...
    sWrap.css({ "padding-top": hWrap.outerHeight(true) });
  ...
  function handleUnSDown() {
    if (
      bds.comm.inputColorConfig &&
      bds.comm.inputColorConfig.barColor &&
      bds.comm.sIndex
    ) {
      sFormWrapper.addClass("scene-style");
    }
    sWrap.css({ "padding-top": 0 });
  ...
  var _roller = {
    ...
    follow: function (start) {
      ...
      if (start) {
        hWrap.css({ left: tWrap.width() / 2 - $(window).scrollLeft() });
      } else {
        hWrap.css({ left: "" });
      }
    },
  ...
  function _bindEvent() {
    ...
    if ($.isIE !== 6) {
      $(window).on("resize", function () {
        tWrap.css({ left: -1 * $(window).scrollLeft() });
      });
    }
  }
  exports.init = init;
