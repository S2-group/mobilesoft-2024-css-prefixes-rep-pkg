...
define("superman/components/video-meet", [
  "require",
  "exports",
  "@baidu/video-meeting",
  "superman/components/guide_tips",
  "superman/lib/event",
], function (require, _exports, Meet, GuideTips, Event) {
  "use strict";
    ...
    _createClass(VideoMeet, [
          ...
          entry
            .on("mouseenter", function (e) {
              if (
                ...
                $(".v-container").parent().css("display") === "none"
              ) {
                GuideTips.close({
                  id: "s_side_wrapper",
                  type: "left",
      ...
      },
      {
        ...
        value: function createMeet(data) {
          ...
          var meet = new meetObj({ data: data });
