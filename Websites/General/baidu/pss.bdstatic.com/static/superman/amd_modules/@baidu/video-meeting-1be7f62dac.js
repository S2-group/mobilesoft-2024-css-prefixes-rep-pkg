  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (a = function () {
        ...
        function i(t, e) {
          for (var n = {}, a = 0; a < e.length; a++) o(n, e[a]);
          var i = t.initData;
          t.initData = i
            ? function () {
            ...
            var r = (function (t) {
                ...
                "function" == typeof t &&
                  ...
                  t.prototype.constructor &&
                    e.push(t.prototype.constructor.prototype));
                return e;
              })(t),
              s = 0;
            s < r.length;
    ...
    function (t, e, n) {
      var a, i;
      (a = [e, n(47), n(51), n(55), n(62), n(16), n(66), n(70)]),
    ...
    function (t, e, n) {
            ...
            (this.bodyUsed = this.bodyUsed),
              ...
              t
                ? "string" == typeof t
                  ...
                  : i.arrayBuffer &&
                    (ArrayBuffer.prototype.isPrototypeOf(t) || r(t))
        ...
        return new Promise(function (n, o) {
          ...
          (s.onload = function () {
            ...
            "include" === r.credentials
              ? (s.withCredentials = !0)
              : "omit" === r.credentials && (s.withCredentials = !1),
            "responseType" in s &&
              (i.blob
                ? (s.responseType = "blob")
                : i.arrayBuffer &&
      ...
      (w.polyfill = !0),
        a.fetch ||
          ((a.fetch = w), (a.Headers = p), (a.Request = v), (a.Response = b));
    },
    function (t, e, n) {
      "use strict";
      (e.__esModule = !0),
        ...
        (e.getBrowser = function () {
          ...
          for (var a in n)
            if (n[a]) {
              var i = "";
              if ("IE" == a) i = t.match(/(msie\s|trident.*rv:)([\w.]+)/)[2];
              else if ("Chrome" === a) {
                for (var o in navigator.mimeTypes)
                  "application/360softmgrplugin" ==
                    navigator.mimeTypes[o].type && (a = "360");
                i = t.match(/chrome\/([\d.]+)/)[1];
              } else
                "Firefox" === a
                  ? (i = t.match(/firefox\/([\d.]+)/)[1])
                  : "Opera" === a
                  ? (i = t.match(/opera\/([\d.]+)/)[1])
                  : "Safari" === a
                  ? (i = t.match(/version\/([\d.]+)/)[1])
                  : "Edge" === a
                  ? (i = t.match(/edge\/([\d.]+)/)[1])
                  : "QQBrowser" === a &&
                    (i = t.match(/qqbrowser\/([\d.]+)/)[1]);
        ...
        f = (function (t) {
          ...
          return (
            ...
            (e.prototype.setStack = function (t) {
              ...
              "add" === t
                ? (e.push(n), this.data.set("preStack", e))
                : "del" === t
                ? e.length > 1 && (e.pop(), this.data.set("preStack", e))
                : this.data.set("preStack", []);
            }),
            ...
            (e.prototype.bindEvent = function (t) {
              var e = this,
                n = this;
              "backflow" !== n.data.get("type") &&
                (t.off("click").on("click", function (t) {
                  var a = e.data.get("showViews");
                  n.data.set("showViews", !a),
                    0 !== e.data.get("status") ||
                      a ||
                      e.updateStatus({ value: 1 }),
                    t.stopPropagation();
                }),
                this.hideViews());
            }),
            (e.prototype.hideViews = function () {
              ...
              document.addEventListener("mousedown", function (e) {
                ...
                document.addEventListener("click", function (i) {
                  t.contains(
                    document.getElementById("passport-login-pop"),
                    i.target
                  ) ||
                    t.contains(
                      document.getElementsByClassName("pop-mask")[0],
                      i.target
                    ) ||
                    (t.contains(n, i.target) || !e || a
                      ? (a = !1)
                      : (t.data.set("showViews", !1), (a = !1)));
                }),
                document
                  .querySelector("#kw")
            ...
            (e.prototype.orderMeetEvent = function (t) {
              ...
              (t.bsToken = this.data.get("bsToken")),
                this.data.set("orderData", t),
                this.updateStatus({ value: 5 });
            }),
            ...
            (e.computed = {
              memberName: function () {
                ...
                t
                  ? (this.data
                      .get("event")
                      .fire("superman:videomeeting", "opendialogClick"),
                    (e.className += " no-scroll"))
                  : e.setAttribute(
                      "class",
                      e.getAttribute("class").replace(" no-scroll", "")
                    );
              },
              errorPos: function () {
                return {
      ...
      var a = n(4),
        ...
        r = (function (t) {
          ...
          return (
            ...
            (e.components = { "v-header": o["default"] }),
            e
          );
        })(i.Component);
      e["default"] = r;
        ...
        r = (function (t) {
          ...
          return (
            ...
            (e.prototype.exitMeet = function () {
              window.localStorage.getItem("video-meet-never")
                ? this.dispatch("exitMeet", 0)
                : this.data.set("exit", !0);
            }),
            (e.prototype.hideMeet = function () {
              this.dispatch("hideMeet", !1);
            }),
            (e.prototype.goBack = function () {
              if (this.data.get("clearMedia")) this.fire("mediaGoback", null);
              else {
            ...
            (e.prototype.cancel = function (t) {
              this.data.set("exit", !1),
                t.never && window.localStorage.setItem("video-meet-never", "1");
            }),
            (e.prototype.confirm = function (t) {
              this.data.set("exit", !1),
                t.never && window.localStorage.setItem("video-meet-never", "1"),
                this.data.get("clearMedia")
                  ? this.fire("mediaExit", null)
                  : this.dispatch("exitMeet", 0);
            }),
            (e.components = { "c-popup": o.Popup }),
            e
          );
        })(i.Component);
      e["default"] = r;
          ...
          return (
            ...
            (e.prototype.attached = function () {
              window.addEventListener
                ? window.addEventListener("click", this.closeBoard.bind(this))
                : window.attachEvent("onclick", this.closeBoard.bind(this));
            }),
            (e.prototype.detached = function () {
              window.removeEventListener
                ? window.removeEventListener(
                    "click",
                    this.closeBoard.bind(this)
                  )
                : window.detachEvent("onclick", this.closeBoard.bind(this));
            }),
            ...
            (e.computed = {
              ...
              list: function () {
                for (
                  var t = this.data.get("dataList"),
                    e = this.data.get("column"),
                    n = [],
                    a = 0;
                  a < t.length;
                  a += e
          ...
          return (
            ...
            (e.prototype.show = function () {
              var t = this.data.get("zindex"),
                e = this.data.get("pos"),
                n = ["z-index:" + t + ";", "opacity: 1;"].join(""),
                a = "";
              if (e) for (var i in e) a += i + ":" + e[i] + ";";
              else {
                var o = this.el;
                a = [
                  "left: 50%;top: 50%;",
        ...
        r = (function (t) {
          ...
          return (
            ...
            (e.prototype.cancel = function () {
              this.fire("cancel", { never: this.data.get("never") }),
                this.close("cancel");
            }),
            (e.prototype.confirm = function () {
              this.fire("confirm", { never: this.data.get("never") }),
                this.close("confirm");
            }),
            (e.components = { "c-checkbox": o["default"] }),
            e
          );
        })(i.Component);
      e["default"] = r;
          ...
          return (
            ...
            (e.computed = {
              ...
              propertyVal: function () {
                ...
                return (
                  e && (t.value = e),
                  this.data.get("checked") && (t.checked = "checked"),
                  t
                );
              },
            }),
        ...
        o = (function (t) {
          ...
          return (
            ...
            (e.prototype.inputSpecialSize = function () {
              var t = this.sourceSlotNameProps
                  ? this.sourceSlotNameProps.length
                  : 0,
                e = this.data.get("clearable"),
                n =
                  this.data.get("inputWidthSize") -
                  22 -
                  26 * t -
                  26 * (e ? 1 : 0),
            ...
            (e.prototype.handleBlur = function (t) {
              this.data.get("clickClear")
                ? (this.getInput().focus(), this.data.set("clickClear", !1))
                : (this.data.set("isFocus", !1), this.fire("blur", t));
            }),
            (e.computed = {
              ...
              inputHeightSize: function () {
                ...
                return "input" === this.data.get("type")
                  ? "input-height-" + (t || "mini")
        ...
        l = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkDateClose = function () {
              this.data.get("showCheckDate") &&
                this.data.set("showCheckDate", !1);
            }),
            ...
            (e.prototype.pickDay = function (t) {
              ...
              if ("current" === t.type) {
                var a = new Date(),
                  i = this.data.get("selectDate");
                a.setFullYear(i.getFullYear(), i.getMonth(), n),
                  this.data.set("selectDate", a),
                  this.checkDateClose(),
                  this.nextTick(function () {
                    e.rows(), e.dateChange();
                  });
            ...
            (e.prototype.changeMonth = function (t) {
              var e = this,
                ...
                p = new Date().getDate();
              "prevMonth" === t
                ? ((p = this.getLastDay(s.getFullYear(), s.getMonth() + 1)),
                  (l =
                    r.getDate() >= p
                      ? new Date(s.setDate(p))
                      : new Date(s.setDate(r.getDate()))),
                  n &&
                    s.getFullYear() === i.getFullYear() &&
                    s.getMonth() === i.getMonth() &&
                    (l =
                      r.getDate() <= i.getDate()
                        ? new Date(i.setDate(i.getDate()))
                        : new Date(i.setDate(r.getDate()))))
                : "nextMonth" === t &&
                  ((p = this.getLastDay(c.getFullYear(), c.getMonth() + 1)),
                  (l =
                    r.getDate() >= p
                      ? new Date(c.setDate(p))
                      : new Date(c.setDate(r.getDate()))),
                  a &&
                    ...
                    (l =
                      (r.getDate(),
                      o.getDate(),
                      new Date(o.setDate(o.getDate()))))),
                this.data.set("selectDate", l),
                this.nextTick(function () {
                  e.rows();
                });
            }),
            ...
            (e.prototype.rows = function () {
              ...
              (e = e.concat(c)),
                this.data.set("renderTbody", this.toNestedArr(e));
            }),
            (e.prototype.attached = function () {
              var t = this;
              s.addEventListener(
                window,
                "click",
                this.checkDateClose.bind(this)
              ),
                this.rows(),
                this.watch("selectDate", function (e) {
                  t.rows();
                }),
          ...
          return (
            ...
            (e.prototype.processDate = function (t, e) {
              return t.date === e.date
                ? t.date + " " + t.time + "-" + e.time
                : t.date + " " + t.time + "-" + e.date + " " + e.time;
            }),
            (e.prototype.attached = function () {
            ...
            (e.prototype.share = function () {
              var t,
                e,
                n = this.data.get("shareInfo"),
                a = "";
              n.partner &&
                n.partner.length > 0 &&
                (a = "参会人\uFF1A" + n.partner.join("\uFF1B")),
                document.querySelector("#copyInput") ||
                  (((t = document.createElement("textarea")).style.opacity =
                    "0"),
                  (t.value =
                    n.owner +
                    " 邀请您参加百度视频云会议\n会议主题\uFF1A " +
                  ...
                  a && (t.value += "\n" + a),
                  (t.value += n.passwd ? "\n参会密码\uFF1A " + n.passwd : ""),
                  (t.value += n.description
                    ? "\n会议描述\uFF1A" + n.description
                    : ""),
                  (t.value += "\n请点击下方链接参加会议\uFF1A\n" + n.meetUrl),
                  (t.contentEditable = !0),
                  t.setAttribute("id", "copyInput"));
              ...
              (e = document.execCommand("copy")),
                this.data.set("copyInit", !0),
                e && this.data.set("pasteShow", !0);
            }),
          ...
          return (
            ...
            (e.prototype.chooseLimits = function (t) {
              ...
              if (t.checked) {
                if ("info" === t.name) {
                  try {
                    this.data.set("choice.info", !0),
                      this.data.set("boxChecked", !0),
                      window.localStorage.setItem("has-checked", "1");
                  } catch (i) {}
                  this.updateBtn();
                }
                this.data.set(a, !0),
                  "live" === n
                    ? this.showVideo()
                    : "voice" === n && this.showVoice();
              } else {
                if ("info" === t.name)
                  try {
                    this.data.set("choice.info", !1),
                      this.data.set("boxChecked", !1),
                      window.localStorage.setItem("has-checked", "0");
                  } catch (i) {}
                this.data.set(a, !1),
                  this.nextTick(function () {
                    e.changeLimit(n);
            ...
            (e.prototype.changeLimit = function (t) {
              ...
              if (e.voice || e.live) {
                if ("live" === t) {
                  if (
                    (this.data.set("noLimit", !!e.voiceStatus), !e.voiceStatus)
                  )
                    return void this.showVoice();
                } else if (
                  "voice" === t &&
                  (this.data.set("noLimit", !!e.liveStatus), !e.liveStatus)
                )
            ...
            (e.prototype.attached = function () {
              ...
              t && "1" === t
                ? (this.data.set("boxChecked", !0),
                  this.data.set("canstartMeet.info", !0))
                : (this.data.set("boxChecked", !1),
                  this.data.set("canstartMeet.info", !1));
              this.data.get("type");
              this.showVoice();
              var e = this.data.get("meetInfo");
              this.data.set("input.name", e.roomowner),
                0 === e.joinStatus
                  ? (this.data.set("submitBtn", "会议未开始"),
                    this.data.set("canstartMeet.limit", !1))
                  : 5 === e.joinStatus &&
                    (this.data.set("submitBtn", "会议已结束"),
                    this.data.set("canstartMeet.limit", !1));
            }),
            (e.prototype.showVideo = function () {
              (this.ref("videoMedia").style = "display:block"),
                this.openVideo("live");
            }),
            (e.prototype.showVoice = function () {
              (this.ref("voiceMedia").style = "display:block"),
                this.openVideo("voice");
            }),
            (e.prototype.updateBtn = function () {
              ...
              e.info
                ? n.info || this.data.set("canstartMeet.info", !1)
                : t && n.info
                ? this.data.set("canstartMeet.info", !0)
                : this.data.set("canstartMeet.info", !1);
            }),
            ...
            (e.prototype.clearMedia = function (t) {
              this.stopMedia("voice"),
                this.stopMedia("live"),
                "back" === t
                  ? this.dispatch("goback", 0)
                  : this.dispatch("exitMeet", 0);
            }),
            (e.prototype.openVideo = function (t) {
              ...
              (e =
                "live" === t
                  ? document.querySelector(".videoMedia")
                  : document.querySelector(".voiceMedia")),
                navigator.mediaDevices
                  ? navigator.mediaDevices
                      .getUserMedia(i)
                      .then(function (a) {
                        n.data.set("noLimit", !1),
                          n.data.set(t + "StreamFlag", a),
                          (e.srcObject = a),
                      ...
                      ["catch"](function (e) {
                        n.enumerateDevices(t, e.toString()),
                          a.stopMedia("live"),
                          a.stopMedia("voice"),
                          n.data.set("noLimit", !0);
                      })
            ...
            (e.prototype.handleErrorMsg = function (t) {
              t.voice && t.live && t.voiceStatus && t.liveStatus
                ? this.setErrorMsg(t.voiceStatus, 0)
                : t.voice && t.voiceStatus
                ? this.setErrorMsg(t.voiceStatus, 1)
                : t.live && t.liveStatus && this.setErrorMsg(t.liveStatus, 2);
            }),
              ...
              l.fetch("/home/meeting/data/checkword?word=" + i, {
                ...
                .then(
                  function (t) {
                    0 !== t.errno
                      ? (a.data.set("warn." + e, !0),
                        a.data.set("canstartMeet." + e, !1))
                      : (a.data.set("warn." + e, !1),
                        a.data.set("canstartMeet." + e, !0),
                        a.data.set("input." + e, i),
                        n && n.call(o)),
                      a.data.set("input.nameChecked", !0);
                  },
                  function (t) {
            ...
            (e.prototype.intoMeet = function () {
              var t = this,
                ...
                r = n.data.get("passwd");
              if (e)
                return ("Chrome" === a.type && a.versions >= 72) ||
                  ("Firefox" === a.type && a.versions >= 75)
                  ? void setTimeout(function () {
                      ...
                      if ("backflow" === o)
                        if (i.needPasswd && "0" !== i.needPasswd) {
                          ...
                          r.length < 6
                            ? t.passStatus(!1)
                            : a.name && a.info && a.pass && a.limit
                            ? n.jumpUrl()
                            : a.name ||
                              t.checkName({ value: e }, "name", t.buildJumpUrl);
                        } else
                          a.name && a.info && a.limit
                            ? n.jumpUrl()
                            : a.name ||
                              t.checkName({ value: e }, "name", t.buildJumpUrl);
                      else
                        a.name && a.info && a.limit
                          ? n.jumpUrl("exit")
                          : a.name ||
                            t.data.get("input.nameChecked") ||
                            n.checkName({ value: e }, "name", t.buildJumpUrl);
                    }, 300)
                  : (n.stopMedia("voice"),
                    n.stopMedia("live"),
                    n.dispatch("exitMeet", 0),
                    void window.open("/home/meeting/show/join?r=" + i.r));
            }),
            (e.prototype.jumpUrl = function (t) {
              this.stopMedia("voice"),
                this.stopMedia("live"),
                "exit" === t && this.dispatch("exitMeet", 0),
                this.buildJumpUrl();
            }),
            (e.prototype.buildJumpUrl = function () {
              ...
              for (var l in ((i || t.passwd) && (c.s = i || t.passwd),
              n && (c.microphone = !0),
              e && (c.camera = !0),
              c))
                r += l + "=" + c[l] + "&";
              (r = r.substring(0, r.length - 1)),
                "backflow" === o ? (window.location.href = r) : window.open(r);
            }),
            (e.prototype.limitName = function (t) {
              t
                ? (t.target.value
                    ? this.data.set("canstartMeet.name", !0)
                    : (this.data.set("input.name", ""),
                      this.data.set("warn.name", !1),
                      this.data.set("canstartMeet.name", !1)),
                  this.data.set("input.nameChecked", !1))
                : (this.data.set("input.name", ""),
                  this.data.set("warn.name", !1),
                  this.data.set("canstartMeet.name", !1));
            }),
            ...
            (e.prototype.passStatus = function (t) {
              this.data.set("warn.pass", !t),
                this.data.set("canstartMeet.pass", t);
            }),
              ...
              if (t) {
                ...
                if (!n)
                  return (
                    ...
                    this.data.set("warn.pass", !1),
                    void this.data.set("canstartMeet.pass", !1)
                  );
                /.*[a-zA-Z\u4e00-\u9fa5]+.*$/.test(n)
                  ? this.passStatus(!1)
                  : (this.passStatus(!0), this.data.set("passwd", n));
              }
            }),
            (e.components = {
              "v-header": o["default"],
            ...
            (e.computed = {
              ...
              checkboxType: function () {
                return "backflow" === this.data.get("type")
                  ? "transparent"
                  : "";
              },
              btnUseful: function () {
                ...
                return e && "0" !== e
                  ? t.name && t.info && t.limit && t.pass
                  : t.name && t.info && t.limit;
              },
            }),
            e
          );
          ...
          return (
            ...
            (e.prototype.attached = function () {
              ...
              this.initPartner(),
                this.initCalDate(),
                p
                  .fetch("/home/meeting/data/meeting", { method: "get" })
                  .then(function (t) {
                    return t.json();
                  })
                  .then(
            ...
            (e.prototype.initCalDate = function () {
              ...
              this.data.get("openPassInput") &&
                (this.ref("passinput").value = o);
              this.data.set("startTime", n.startSelectList[a]),
                this.data.set("endTime", n.endSelectList[i]),
                this.data.set("startCalData.calObj", this.calParser(e)),
                this.data.set("endCalData.calObj", this.calParser(t));
            }),
            ...
            (e.prototype.checkAvailableCal = function () {
              var t,
                e,
                n = this.data.get("startCalData.calObj");
              n
                ? ((t = new Date(n.selectDate.getTime() + 1800000)),
                  (e = n.selectDate.getTime() + 86400000))
                : ((t = new Date(new Date().getTime() + 1800000)),
                  (e = new Date().getTime() + 86400000)),
                this.data.set("endCalData.limitBefore", t),
                this.data.set("endCalData.initShow", t),
                this.data.set("endCalData.calObj", {
                  selectDate: t,
                  selectDateDay: t.getDate(),
                  selectDateMonth: t.getMonth() + 1,
                  selectDateYear: t.getFullYear(),
                }),
                this.data.set("endCalData.limitAfter", e),
                this.data.set("orderData.endIndex", 1);
            }),
            (e.prototype.openPass = function (t) {
              if ("passwd" === t.name) {
                ...
                this.data.set("openPassInput", !e),
                  t.checked ||
                    (this.data.set("passwd", ""),
                    this.data.set("warn.pass", !1)),
                  a &&
                    0 === n &&
                    (this.data.set("updatePasswd", 1), this.clearPasswdInput());
              }
            }),
            (e.prototype.clearPasswdInput = function () {
              (this.ref("passinput").value = ""),
                this.data.set("passwd", ""),
                this.data.set("passShow", !0);
            }),
            (e.prototype.getValue = function (t) {
              if (t) {
                var e = t.target;
                e.value &&
                  (this.data.set("roomName", e.value), this.checkName(e.value));
              }
            }),
            ...
            (e.prototype.updateDesc = function (t) {
              t &&
                (t.target.value ||
                  (this.data.set("warn.desc", !1),
                  this.data.set("canOpenMeet.desc", !0)));
            }),
            (e.prototype.switchPass = function (t) {
              ...
              if (this.data.get("modifyMeet") && 0 === i)
                return (
                  this.data.set("updatePasswd", 1),
                  (n.value = ""),
                  this.data.set("passwd", ""),
                  void n.focus()
                );
              this.data.set("passShow", e),
                a && (n.value = "show" != t ? a.replace(/./g, "*") : a);
            }),
            (e.prototype.processPassFocus = function () {
              var t = this.data.get("updatePasswd");
              this.data.get("modifyMeet") &&
                0 === t &&
                (this.data.set("updatePasswd", 1), this.clearPasswdInput());
            }),
            (e.prototype.passStatus = function (t) {
              this.data.set("warn.pass", !t),
                this.data.set("canOpenMeet.pass", t);
            }),
                ...
                if (!(n.length > 6))
                  if ((this.passStatus(!0), this.data.get("passShow")))
                    ...
                    if (a.length > n.length)
                      (a = (a = a.substring(0, n.length - 1)).substring(0, 6)),
                        this.data.set("passwd", a);
                    else {
                      var i = n.split("*");
                      (a += i[i.length - 1]),
                        (e.value = n.replace(/./g, "*")),
            ...
            (e.prototype.updateDataList = function (t, e) {
              var n = this.data.get(t + "CalData.calObj"),
                a = new Date(),
                i =
                  (this.data.get("startSelectList"), this.updateTime("start")),
                o = this.updateTime("end"),
                r = [],
                s = [];
              if (
                n.selectDateYear !== a.getFullYear() ||
                n.selectDateMonth !== a.getMonth() + 1 ||
                n.selectDateDay !== a.getDate()
              ) {
                var c = this.isOneDay();
                "start" === t
                  ? ("cal" !== e
                      ? ((s = this.formatEndList(i, !0)),
                        (o = this.updateTime("end", s[1], 1)))
                      : ((i = this.updateTime("start", "0:00", 1)),
                        (o = this.updateTime("end", "1:00", 1)),
                        (r = this.formatStartList(i, 1)),
                        (s = this.formatEndList(i, !0)),
                        this.data.set("orderData.startSelectList", r),
                        this.data.set("orderData.startIndex", 0)),
                    this.data.set("orderData.endSelectList", s),
                    ("cal" !== e && o.hour > i.hour) ||
                    (i.hour === o.hour && o.minutes > i.minutes)
                      ? this.data.set("orderData.endIndex", s.indexOf(o.time))
                      : this.data.set("orderData.endIndex", 1))
                  : (c
                      ? ((r = this.formatEndList(i, !0)),
                        this.data.set("orderData.endIndex", 1))
                      : ((r = this.formatEndList(i, !1)),
                        this.data.set("orderData.endIndex", 0)),
                    this.data.set("orderData.endSelectList", r));
              } else {
                var l = a.getHours(),
                  p = a.getMinutes();
                "cal" === e
                  ? ((i = this.updateTime("start", l + ":" + p)),
                    "start" === t
                      ? ((r = this.formatStartList(i, 1)),
                        (s = this.formatEndList(i, !0)),
                        this.data.set("orderData.startSelectList", r),
                  ...
                  : ((s = this.formatEndList(i, !0)),
                    this.data.set("orderData.endSelectList", s),
                    s.length > 1 && "23:00" !== i.time
                      ? this.data.set("orderData.endIndex", 1)
                      : this.data.set("orderData.endIndex", 0),
                    this.data.set("endTime", s[1]));
              }
            }),
            (e.prototype.formatStartList = function (t, e) {
              ...
              for (var o = i; o < 24; o++)
                o > i || 0 === i
                  ? (a.push(o + ":00"), a.push(o + ":30"))
                  : n.minutes <= 30 && o === i && a.push(o + ":30");
              return a;
            }),
            (e.prototype.formatEndList = function (t, e) {
              ...
              var o = [];
              return (
                24 === n && ((i = !1), this.updateEndCal()),
                i
                  ? ((o = this.timeLoop(n, 24)), a || o.shift())
                  : ((o = this.timeLoop(0, n)), a || o.pop()),
                o
              );
            }),
            (e.prototype.updateEndCal = function () {
              ...
              this.data.set("endCalData.limitBefore", a),
                this.data.set("endCalData.initShow", a),
                this.data.set("endCalData.calObj", n);
            }),
            ...
            (e.prototype.updateTime = function (t, e, n) {
              var a;
              e
                ? ((a = e), this.data.set(t + "Time", e))
                : (a = this.data.get(t + "Time"));
              var i = a.split(":");
              return i
                ? {
                    hour: Number(i[0]),
            ...
            (e.prototype.isOneDay = function () {
              ...
              return (
                t || (t = { selectDateDay: new Date().getDate() }),
            ...
            (e.prototype.upDateMeet = function (t) {
              var e = this,
                n = this.data.get("updatePasswd");
              this.data.get("modifyMeet") && 0 === n && t.set("passwd", ""),
                t.append("roomId", this.data.get("roomId")),
                t.append("updatePasswd", n);
              var a = this;
              p.fetch("/home/meeting/submit/update", {
                ...
                .then(
                  function (t) {
                    0 === t.errno &&
                      ((t.data.url = a.data.get("url")),
                      (t.data.passwd = e.data.get("passwd")),
                      (t.data.roomTag = a.data.get("roomTag")),
                      a.fire("intoMidpage", t.data));
                  },
                  function (t) {
            ...
            (e.prototype.openMeet = function () {
              ...
              n && !i.title && this.checkName(n),
                a && !i.desc && this.checkName(a, "desc"),
                setTimeout(function () {
                  ...
                  if (i.title && i.pass && i.desc) {
                    var o = new FormData(),
                      ...
                      c = t;
                    o.append("roomName", n),
                      o.append("startTime", "" + r),
                      o.append("endTime", "" + s),
                      o.append("passwd", t.data.get("passwd")),
                      a && o.append("description", t.data.get("description")),
                      t.data.get("partner") &&
                        t.data.get("partner").length &&
                        o.append(
                          "roomPartner",
                          JSON.stringify(t.data.get("partner"))
                        ),
                      o.append("bsToken", t.data.get("orderData.bsToken")),
                      e
                        ? t.upDateMeet(o)
                        : p
                            .fetch("/home/meeting/submit/order", {
                              method: "post",
                              body: o,
                            })
                            .then(function (t) {
                            ...
                            .then(
                              function (e) {
                                0 === e.errno &&
                                  ((e.data.passwd = t.data.get("passwd")),
                                  c.fire("intoMidpage", e.data));
                              },
                              function (e) {
                                t.dispatch("disconnectedError", !0);
                              }
            ...
            (e.prototype.checkName = function (t, e) {
              ...
              e || (e = "title"),
                p
                  .fetch("/home/meeting/data/checkword?word=" + t, {
                    method: "get",
                  })
                  .then(function (t) {
                    return t.json();
                  ...
                  .then(
                    function (t) {
                      0 !== t.errno
                        ? (n.data.set("warn." + e, !0),
                          n.data.set("canOpenMeet." + e, !1),
                          n.data.set("inputStatus." + e, !1))
                        : (n.data.set("canOpenMeet." + e, !0),
                          n.data.set("warn." + e, !1),
                          n.data.set("inputStatus." + e, !0));
                    },
                    function (t) {
            ...
            (e.prototype.chooseDate = function (t, e) {
              "start" === e
                ? (this.data.set("startCalData.calObj", t),
                  this.checkAvailableCal(),
                  this.updateDataList("start", "cal"))
                : (this.data.set("endCalData.calObj", t),
                  this.updateDataList("end", "cal"));
            }),
            (e.prototype.chooseTime = function (t, e) {
              this.data.set("orderData." + e + "Index", t.index),
                "start" === e
                  ? (this.data.set("startTime", t.data),
                    this.updateDataList("start", "sel"))
                  : this.data.set("endTime", t.data);
            }),
            (e.prototype.limitName = function (t) {
              t &&
                (t.target.value
                  ? this.data.set("canOpenMeet.title", !0)
                  : this.data.set("warn.title", !1));
            }),
            (e.components = {
              "v-header": o["default"],
              "v-foot": r["default"],
        ...
        i = (function (t) {
          ...
          return (
            ...
            (e.prototype.inputFocus = function () {
              ...
              t.value &&
                -1 !== t.value.indexOf("@") &&
                this.data.set("showsug", !0),
                this.data.set("showPlaceholder", !1),
                this.hideSug();
            }),
            (e.prototype.startInput = function (t) {
              var e,
                n = this.data.get("mailList"),
            ...
            (e.prototype.findMatchMail = function (t, e) {
              for (
                var n = this.data.get("mailList"), a = [], i = 0;
                i < n.length;
                i++
              )
            ...
            (e.prototype.emailInputBlur = function () {
              this.ref("emailInput").value ||
                (document.querySelector(".selectSugOpt") ||
                  this.data.set("showPlaceholder", !0),
            ...
            (e.prototype.hideSug = function () {
              ...
              document
                .querySelector(".v-container")
                .addEventListener("click", function (a) {
                  t.contains(e, a.target) ||
                    t.contains(n, a.target) ||
                    t.data.set("showsug", !1);
                });
            }),
            (e.prototype.insertPartner = function (t) {
              ...
              this.data.set("inputStatus", !1),
                a.setAttribute("class", "selectSugOpt"),
                i.setAttribute("class", "selectSugVal"),
                (i.innerText = t.split("@")[0]),
                o.setAttribute("class", "c-icon selectSugIcon c-color-gray2"),
                (o.innerHTML = "&#xe610;"),
                a.appendChild(i),
                a.appendChild(o),
                n.appendChild(a);
              ...
              r.push(t),
                e.data.set("partner", r),
                e.fire("setPartner", e.data.get("partner")),
        ...
        d = (function (t) {
          ...
          return (
            ...
            (e.prototype.quickMeet = function () {
              ...
              if (
                ...
                e.append("start", "1"),
                  e.append("bsToken", n),
                  c
                    .fetch("/home/meeting/submit/quickstart", {
                      method: "post",
                      body: e,
                    })
                    .then(function (t) {
                    ...
                    .then(function (e) {
                      0 === e.errno && e.data
                        ? t.fire("quickmeet", e)
                        : 2009 === e.errno && t.data.set("errorWarn", !0);
                    })
                    ["catch"](function (e) {
                      t.dispatch("disconnectedError", !0);
                    });
            ...
            (e.prototype.selectListInit = function (t) {
              var e,
                ...
                a = (e =
                  "Start" === t
                    ? new Date()
                    : new Date(new Date().getTime() + 1800000)).getHours();
              e.getMinutes() > 30 && (a += 1);
              for (var i = a; i < 24; i++)
            ...
            (e.prototype.showTips = function () {
              var t = p.getBrowser();
              return !(
                ("Chrome" === t.type && t.versions >= 72) ||
                ("Firefox" === t.type && t.versions >= 75)
              );
            }),
            (e.prototype.switchToast = function () {
    ...
    function (t, e, n) {
      ...
      function a() {
        fetch("/home/meeting/data/meeting", { method: "get" })
          ...
          .then(function (t) {
            0 === t.errno &&
              t.bindInfo &&
              (1 === t.bindInfo.isBindPhone
                ? window.location.reload()
                : $.getScript(
                    "//passport.baidu.com/passApi/js/uni_armorwidget_wrapper.js",
                    function () {
                      passport.pop
                        .ArmorWidget("bindmobile", {
                          token: t.bindInfo.bindToken,
                          title: "绑定手机",
                          msg: "",
                          auth_title: "绑定手机",
                          auth_msg:
                            "为了保证您的帐号安全\uFF0C绑定手机前请先进行安全验证",
      ...
      (e.__esModule = !0),
        (e.bdsLogin = e.login = void 0),
        (e.login = function (t) {
          return new Promise(function (e, n) {
            $.getScript(
              "//passport.baidu.com/passApi/js/uni_login_wrapper.js",
              function () {
                (t = passport.pop.init({
                  loginVersion: "v4",
                  apiOpt: {
        ...
        l = (function (t) {
          ...
          return (
            ...
            (e.prototype.changeMeetStatus = function (t) {
              var e = this;
              this.data.get("meetStatus") !== t &&
                (this.data.set("meetStatus", t),
                this.data.set("meetList", []),
                this.data.set("originList", []),
                this.data.set("page", 0),
                this.data.set("loadStatus", 2),
                this.data.set("noMeet", !1),
                this.nextTick(function () {
                  e.getMeetData();
                }));
            }),
            ...
            (e.prototype.getMeetData = function () {
              ...
              this.data.set("loadStatus", 2),
                this.nextTick(function () {
                  fetch(
                    t.getUrlParams("/home/meeting/data/list", {
                      role: i,
                      status: n,
                      page: o,
                      pn: 10,
                    ...
                    .then(
                      function (n) {
                        n.data.info && 0 === n.data.info.length && 0 === o
                          ? t.data.set("noMeet", !0)
                          : (t.data.set("noMeet", !1),
                            (c = a.__spreadArrays(c, n.data.info)),
                            (s = e.parseMeetList(c)),
                            e.data.set("originList", c),
                            e.data.set("meetList", s),
                            n.data.count < 10
                              ? e.data.set("loadStatus", 0)
                              : e.data.set("loadStatus", 1),
                            e.nextTick(function () {
                              r &&
                                (r.removeEventListener("scroll", e.scrollEvent),
                                r.addEventListener(
                                  "scroll",
                                  e.scrollEvent.bind(e)
                                ));
                            }));
                      },
                      function (e) {
                        t.dispatch("disconnectedError", !0),
                          t.data.set("loadStatus", 1);
                      }
                    );
                });
            }),
            ...
            (e.prototype.parseMeetList = function (t) {
              for (var e = [], n = 0; n < t.length; n++)
                0 !== n
                  ? e[e.length - 1].titleDate ===
                    this.parseDate(1000 * t[n].startTime.utcTime)
                    ? (e[e.length - 1].msg.push(t[n]),
                      (e[e.length - 1].endCount = n + 1))
                    : e.push({
                        titleDate: this.parseDate(
                          1000 * t[n].startTime.utcTime
                        ),
            ...
            (e.prototype.scrollEvent = function () {
              ...
              for (var n = 0; n < t.length; n++)
                e.scrollTop >=
                  this.computedHeight("start", t[n].startCount, n) + 1 &&
                  e.scrollTop <= this.computedHeight("end", t[n].endCount, n) &&
                  this.data.set(
                    "fixedTitle",
                    this.parseShowDate(t[n].titleDate, t[n].week)
                  );
            }),
            (e.prototype.updateMeet = function (t) {
              var e = this,
              ...
              this.data.set("originList", a),
                this.data.set("meetList", i),
                this.nextTick(function () {
                  n.removeEventListener("scroll", e.scrollEvent),
                    n.addEventListener("scroll", e.scrollEvent.bind(self));
                });
            }),
            (e.prototype.getMyMeet = function (t) {
              var e = this;
              this.data.get("myMeet") !== t.data.value &&
                (this.data.set("myMeet", t.data.value),
                this.data.set("meetList", []),
                this.data.set("originList", []),
                this.data.set("page", 0),
                this.nextTick(function () {
          ...
          return (
            ...
            (e.prototype.confirm = function () {
              var t = this,
                ...
                a = new FormData(),
                i = this;
              a.append("roomId", e.roomId),
                a.append("bsToken", n),
                fetch("/home/meeting/submit/delete", {
                  method: "post",
                  body: a,
                })
                  .then(function (t) {
            ...
            (e.prototype.reOrderMeet = function (t) {
              ...
              (s.utcTime = n / 1000),
                (r.utcTime = n / 1000),
                e.getHours() >= 23 &&
                  ((s.utcTime = (e.setHours(23, 59, 59, 999) + 1) / 1000),
                  e.getMinutes() >= 30 &&
                    (r.utcTime = (e.setHours(23, 59, 59, 999) + 1) / 1000));
            ...
            (e.prototype.modifyMeet = function (t) {
              var e = this.selectListInit(
                  "modifyMeet",
                  new Date(1000 * t.startTime.utcTime),
                  "start"
                ),
                n = this.selectListInit(
                  "modifyMeet",
                  new Date(1000 * t.startTime.utcTime + 1740000),
                  "end"
                ),
                i = t.startTime,
                o = t.endTime,
            ...
            (e.prototype.share = function (t) {
              ...
              var a,
                ...
                r =
                  ...
                  "-" +
                  t.endTime.time;
              t.startTime.date !== t.endTime.date &&
                (r =
                  t.startTime.date +
                  " " +
                  t.startTime.time +
                  ...
                  " " +
                  t.endTime.time),
                ((a = document.createElement("textarea")).style.opacity = "0"),
                ...
                n && (a.value += "\n" + n),
                (a.value += t.passwd ? "\n参会密码\uFF1A " + t.passwd : ""),
                (a.value += t.description
                  ? "\n会议描述\uFF1A" + t.description
                  : ""),
                (a.value += "\n请点击下方链接参加会议\uFF1A\n" + t.url),
                (a.contentEditable = !0),
                a.setAttribute("id", "copyInput"),
                e.appendChild(a),
                a.select(),
                (o = document.getSelection()),
                (i = document.createRange()).selectNode(a),
                o.addRange(i),
                a.setSelectionRange(0, a.value.length),
                document.execCommand("copy") && this.fire("shareEvent", !0);
            }),
            ...
            (e.computed = {
              memberName: function () {
                ...
                return t.partner && t.partner.length
                  ? t.partner.reduce(function (t, e) {
                      return t + (e ? "\u3001" : "") + e;
                    })
                  : "";
              },
      ...
      var a = n(4),
        ...
        c = (function (t) {
          ...
          return (
            ...
            (e.prototype.attached = function () {
              this.data.set("browserInfo", s.getBrowser()),
                "unlogin" === this.data.get("flowType") && this.login();
            }),
            (e.computed = {
              text: function () {
                ...
                var n = this.data.get("browserInfo"),
                  ...
                  i =
                    "//www.baidu.com/s?wd=" +
                    encodeURIComponent("chrome网络浏览器下载") +
                    "&rsv_dl=meeting";
                return e
                  ? (("Chrome" !== n.type && "Firefox" !== n.type) ||
                    ("Chrome" === n.type && n.versions < 72)
                      ? (a = "Chrome")
                      : "Firefox" === n.type &&
                        n.versions < 75 &&
                        ((a = "Firefox"),
    ...
    function (t, e) {
      t.exports =
        ' <div class="{{$style[\'wrapper\']}} v-container"> <v-header title="用户反馈" status="2" closeType="exit"></v-header> <div class="{{ $style[\'iframe-wrapper\'] }}"> <iframe class="{{ $style[\'fk-iframe\'] }}" src="//ufosdk.baidu.com/ufosdk/postview/%2BuS7%2FtBBbja2UESRWUp3Xw%3D%3D/245829" frameborder="0"></iframe> </div> </div> ';
    },
    function (t, e, n) {
      var a = n(2),
        i = n(45);
    ...
    function (t, e) {
      t.exports =
        ' <div class="{{$style.header}}"> <i s-if="needBack" class="c-icon {{$style.icon}} c-color-gray2" on-click="goBack">&#xe617;</i> <span s-if="title" class="{{$style.title}}">{{ title }}</span> <i s-if="closeType === \'hide\'" class="{{$style.hide}} c-icon" on-click="hideMeet">&#xe610;</i> <span s-if="closeType === \'exit\'" class="{{$style.exit}} c-color-gray2" on-click="exitMeet">退出</span> <c-popup s-if="exit" title="您将退出百度视频会议" on-cancel="cancel($event)" on-confirm="confirm($event)" on-close="cancel" zIndex="4" primaryBtnText="退出"></c-popup> </div> ';
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(48)],
    ...
    function (t, e) {
      t.exports =
        ' <span class="{{$style.toastWrapper}}" style="{{customStyle}}"> <slot></slot> </span> ';
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(56)],
    ...
    function (t, e) {
      t.exports =
        " <button class=\"c-btn {{ btnType }} {{ btnSize }} {{ type === 'white' ? $style['btn-white'] : ''}} {{ type === 'default' ? $style['btn-default'] : '' }} {{ size === 'auto' ? $style['btn-auto'] : ''}} {{ size === 'wide' ? $style['btn-wide'] : '' }} {{ size === 'weak' ? $style['btn-weak'] : '' }} {{ $style['btn-' + size] }}\" on-click=\"buttonClick\"> <i s-if=\"icon && size !== 'mini'\" class=\"{{ $style['btn-icon'] }} c-icon\">{{ icon }}</i><template s-if=\"text\">{{ text }}</template> <template s-else><slot></slot></template> </button> ";
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(67)],
    ...
    function (t, e) {
      t.exports =
        ' <div class="{{$style[\'input-wrapper\']}}"> <div s-if="type === \'input\'" class="c-input {{ $style[\'input\'] }} {{ $style[inputHeightSize] }} {{ isFocus ? $style[\'focus-color\'] : \'\' }}" style="width: {{inputWidthSize}}px;"> <div class="{{ $style[\'left\'] }}"> <slot name="left-icon"></slot> </div> <div class="{{ $style[\'contain\'] }}" style="{{ inputSpecialSize() }}"> <input s-ref="input" type="text" placeholder="{{ placeholder }}" s-bind="{{ params }}" value="{= value =}" on-input="handleInput" on-focus="handleFocus" on-blur="handleBlur"> </div> <div s-if="clearable" class="{{ $style[\'clear-icon\'] }} {{ $style[\'input-icon\'] }} {{ value && isFocus ? \'\' : $style[\'clear-none\']}}" on-mousedown="clearInput"> <span class="c-icon"> &#xe610; </span> </div> <div class="{{ $style[\'right\'] }}"> <slot name="right-icon"></slot> </div> </div> <div s-else class="{{ $style[\'textarea-wrapper\'] }}"> <textarea s-ref="textarea" placeholder="{{ placeholder }}" s-bind="{{ params }}" class="c-textarea {{ $style[\'textarea\']}} {{ $style[inputHeightSize] }}" style="width: {{inputWidthSize}}px;" value="{= value =}" on-input="handleInput" on-focus="handleFocus" on-blur="handleBlur"></textarea> <div s-if="waterMarkStyle" class="{{ $style[\'water-mark\'] }}" style="{{ waterMarkStyle }}" on-click="clickWaterMark"></div> </div> </div> ';
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(71)],
    ...
    function (t, e, n) {
      "use strict";
      (e.__esModule = !0),
        (e.lessThanIE8 = e.removeEventListener = e.addEventListener = void 0);
    ...
    function (t, e) {
      t.exports =
        ' <div class="{{$style.foot}}"> <button on-click="footEvent(type)" class="{{type === \'feedback\' ? \'c-color-gray2\' : \'c-color-gray\'}}">{{ text }}</button> <div s-if="tipText" class="c-gap-top-small {{$style[\'tip-color\']}}">{{ tipText }}</div> </div> ';
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(91)],
    ...
    function (t, e) {
      t.exports =
        ' <div class="{{$style.wrapper}}"> <i class="c-icon {{$style.icon}}">&#xe656;</i> <span>{{ text }}</span> </div> ';
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(98)],
    ...
    function (t, e) {
      t.exports =
        ' <div class="{{$style[\'init\']}} v-container"> <v-header closeType="hide" needBack="{{ false }}"></v-header> <div class="{{$style.content}}"> <div class="{{$style.title}}">百度视频会议</div> <div class="{{$style.info}} c-color-gray2">免费开放不限时\uFF0C高清稳定智能降噪<br/>无需安装客户端一秒入会</div> <c-btn text="快速会议" type="primary" size="large" on-click="quickMeet" class="{{ $style.btn }} {{ $style.btnblue }}"></c-btn> <c-btn text="预约会议" type="default" size="large" on-click="orderMeet" class="{{ $style.btn }}"></c-btn> <c-btn text="会议管理" type="default" size="large" class="{{ $style.btn }}" on-click="meetManage"></c-btn> <c-toast s-if="errorWarn" pos="{{ pastePos }}" on-hide="switchToast">操作太频繁\uFF0C请稍后再试</c-toast> </div> <v-foot s-if="showFeedBack" on-logSend="logSend($event)" text="用户反馈" type="feedback" tipText="{{showTips() ? \'为保证参会体验\uFF0C请使用Chrome或Firefox浏览器\' : \'\'}}"></v-foot> </div> ';
    },
    function (t, e, n) {
      var a = n(1),
        i = [n(110)],
