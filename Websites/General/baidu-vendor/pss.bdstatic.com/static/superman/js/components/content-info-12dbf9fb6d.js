    ...
    _createClass(ContentInfo, [
      ...
      },
      {
        ...
        value: function createdTip() {
          ...
          var openTriggle = $(
            '<div class="open-content-info"><span class="c-icon c-color-gray2">&#xe60c;</span></div>'
          );
      ...
      },
      {
        ...
        value: function render(firstPaint) {
          ...
          if (firstPaint) {
            ...
            this.bottomLayer.css({ visibility: "visible", width: "100%" });
          } else {
      ...
      },
      {
        ...
        value: function safariFix() {
          ...
          setTimeout(function () {
            ...
            if (res) {
              _this.bottomLayer.css({ width: windowWidth + "px" });
            } else {
              _this.bottomLayer.css({ width: "100%" });
            }
          }, 800);
        },
      },
