define("plugins/bzPopper", ["require"], function () {
  ...
  function P(e, t, n) {
    ...
    return (
      (i || (!i && !n)) &&
        (("body" !== v(t) || x(r)) && (a = h(t)),
        d(t)
          ? ((c = s(t)), (c.x += t.clientLeft), (c.y += t.clientTop))
          : r && (c.x = b(r))),
      {
  ...
  function k(e) {
    return "html" === v(e)
      ? e
      : e.assignedSlot || e.parentNode || e.host || y(e);
  }
  function E(e) {
  ...
  function T(e) {
    for (var t = p(e), n = L(e); n && A(n) && "static" === w(n).position; )
      n = L(n);
    return n && "body" === v(n) && "static" === w(n).position
      ? t
      : n || j(e) || t;
  }
  function C(e) {
  ...
  function Y(e, t) {
    ...
    var n = t,
      ...
      k = s(w),
      E = W({ reference: k, element: x, strategy: "absolute", placement: o }),
      ...
      function o() {
        c.orderedModifiers.forEach(function (e) {
          ...
          if ("function" == typeof o) {
            var i = o({ state: c, name: t, instance: p, options: r }),
              a = function () {};
            u.push(i || a);
          }
        });
          ...
          setOptions: function (n, u) {
            a(),
              (c.options = Object.assign(
                Object.assign(Object.assign({}, i), c.options),
                n
              )),
              (c.scrollParents = {
                reference: f(e)
              ...
              if (J(t, n)) {
                ...
                for (var r = 0; r < c.orderedModifiers.length; r++)
                  if (c.reset !== !0) {
                    ...
                    "function" == typeof i &&
                      (c =
                        i({ state: c, options: u, name: l, instance: p }) || c);
                  } else (c.reset = !1), (r = -1);
              }
            }
          },
  ...
  function et(e) {
    ...
    return { x: Math.round(t * o) / o || 0, y: Math.round(n * o) / o || 0 };
  }
  function tt(e) {
    var t,
      n = e.popper,
    ...
    if (u) {
      ...
      b === p(n) && (b = y(n)),
        o === aa &&
          ((h = ca), (f -= b.clientHeight - r.height), (f *= c ? 1 : -1)),
        o === sa &&
          ((m = ua), (l -= b.clientWidth - r.width), (l *= c ? 1 : -1));
    }
    var w = Object.assign({ position: a }, u && Ia);
    if (c) {
      var x;
      return Object.assign(
        Object.assign({}, w),
  ...
  function it(e, t, n) {
    ...
    return (
      (a = a || 0),
      (c = (c || 0) * o),
      [sa, ua].indexOf(r) >= 0 ? { x: c, y: a } : { x: a, y: c }
    );
  }
  function at(e) {
    var t = e.state,
    ...
    if (!t.modifiersData[r]._skip) {
      for (
        var o = n.mainAxis,
          ...
          y = v === h,
          b = u || (y || !g ? [ct(h)] : pt(h)),
          w = [h].concat(b).reduce(function (e, n) {
            return e.concat(
              M(n) === pa
                ? st(t, {
                    placement: n,
  ...
  function gt(e) {
    var t = e.state,
      ...
      g = n.tetherOffset,
      m = void 0 === g ? 0 : g,
      h = Y(t, { boundary: u, rootBoundary: s, padding: l, altBoundary: p }),
      v = M(t.placement),
      y = U(t.placement),
      b = !y,
      w = G(v),
  ...
  function bt(e) {
    ...
    (t.modifiersData[n] = {
      ...
      (t.attributes.popper = Object.assign(
        Object.assign({}, t.attributes.popper),
        {},
        { "data-popper-reference-hidden": p, "data-popper-escaped": l }
      ));
  }
  var wt =
    ...
    Pt =
      ...
      xt(
        "object" == ("undefined" == typeof self ? "undefined" : n(self)) && self
      ) ||
      xt("object" == ("undefined" == typeof wt ? "undefined" : n(wt)) && wt) ||
      (function () {
        return this;
      })() ||
    ...
    Ht = function (e, t) {
      if (!zt(e)) return e;
      var n, r;
      if (t && "function" == typeof (n = e.toString) && !zt((r = n.call(e))))
        return r;
      if ("function" == typeof (n = e.valueOf) && !zt((r = n.call(e))))
        return r;
      if (!t && "function" == typeof (n = e.toString) && !zt((r = n.call(e))))
        return r;
  ...
  "function" != typeof nn.inspectSource &&
  ...
  var Sn = { set: on, get: an, has: cn, enforce: bn, getterFor: wn },
    An = t(function (e) {
      var t = Sn.get,
        n = Sn.enforce,
      ...
      (e.exports = function (e, t, o, i) {
        ...
        return (
          "function" == typeof o &&
            ("string" != typeof t || Bt(o, "name") || Xt(o, "name", t),
            (a = n(o)),
            a.source || (a.source = r.join("string" == typeof t ? t : ""))),
          e === Pt
            ? void (u ? (e[t] = o) : $t(t, o))
            : (c ? !s && e[t] && (u = !0) : delete e[t],
              void (u ? (e[t] = o) : Xt(e, t, o)))
        );
    ...
    ir = function (e, t) {
      ...
      if ((r = p ? Pt : l ? Pt[s] || $t(s, {}) : (Pt[s] || {}).prototype))
        for (i in t) {
          if (
            ((c = t[i]),
            e.noTargetGet ? ((u = or(r, i)), (a = u && u.value)) : (a = r[i]),
            (n = rr(p ? i : s + (l ? "." : "#") + i, e.forced)),
            !n && void 0 !== a)
          ) {
            if (o(c) === o(a)) continue;
            Jn(c, a);
    ...
    cr = t(function (e) {
      ...
      var n = Kt.f,
        ...
        a = function (e) {
          n(e, r, { value: { objectID: "O" + ++o, weakData: {} } });
        },
        c = function (e, n) {
          if (!zt(e))
            return "symbol" == t(e)
    ...
    dr = function (e) {
      return (
        Bt(pr, e) || (pr[e] = ur && Bt(lr, e) ? lr[e] : fr("Symbol." + e)),
        pr[e]
      );
    },
    gr = {},
    ...
    Sr = Pr
      ...
      : function (e) {
          ...
          return void 0 === e
            ...
            : null === e
            ? "Null"
            : "string" == typeof (n = Er((t = Object(e)), Or))
            ? n
            : kr
            ? Dt(t)
            : "Object" == (r = Dt(t)) && "function" == typeof t.callee
            ? "Arguments"
            : r;
        },
    Ar = dr("iterator"),
  ...
  var Hr,
    ...
    Vr = function (e, t, n) {
      e &&
        !Bt((e = n ? e : e.prototype), Fr) &&
        Br(e, Fr, { configurable: !0, value: t });
    },
    Ur = function (e) {
      if (!zt(e) && null !== e)
      ...
      if (
        ...
        g ||
          ((u = t(function (t, n) {
            Dr(t, u, e);
            var o = Wr(new a(), t, u);
            return void 0 !== n && Cr(n, o[i], { that: o, AS_ENTRIES: r }), o;
          })),
          (u.prototype = c),
          (c.constructor = u)),
          (d || m) && (p("delete"), p("has"), r && p("get")),
          (m || f) && p(i),
          o && c.clear && delete c.clear;
      }
      return (
        (s[e] = u),
        ir({ global: !0, forced: u !== a }, s),
        Vr(u, e),
        o || n.setStrong(u, e, r),
        u
      );
    ...
    Zr = kt
      ...
      : function (e, t) {
          Zt(e);
          for (var n, r = Qr(t), o = r.length, i = 0; o > i; )
            Kt.f(e, (n = r[i++]), t[n]);
          return e;
        },
  ...
  var ao,
    ...
    so =
      ...
      function (e, t) {
        ...
        return (
          null !== e
            ? ((to[Xr] = Zt(e)), (n = new to()), (to[Xr] = null), (n[eo] = e))
            : (n = io()),
          void 0 === t ? n : Zr(n, t)
        );
      },
  ...
  [].keys &&
    ((uo = [].keys()),
    "next" in uo
      ? ((co = ho(ho(uo))), co !== Object.prototype && (ao = co))
      : (yo = !0));
  var wo =
    void 0 === ao ||
    Ot(function () {
  ...
  var xo = { IteratorPrototype: ao, BUGGY_SAFARI_ITERATORS: yo },
      ...
      if (
        (h &&
          ...
          Eo !== Object.prototype &&
            c.next &&
            (ho(c) !== Eo &&
              (Gr ? Gr(c, Eo) : "function" != typeof c[Ao] && Xt(c, Ao, Co)),
            Vr(c, l, !0))),
        o === jo &&
          g &&
          g.name !== jo &&
        ...
        if (((u = { values: p(jo), keys: i ? m : p(Lo), entries: p(To) }), a))
          for (s in u) (!So && !f && s in d) || An(d, s, u[s]);
        else ir({ target: t, proto: !0, forced: So || f }, u);
      return u;
    },
    Mo = dr("species"),
    Io = function (e) {
      ...
      getConstructor: function (e, t, n, r) {
        var o = e(function (e, i) {
            Dr(e, o, t),
              ...
              kt || (e.size = 0),
              void 0 !== i && Cr(i, e[r], { that: e, AS_ENTRIES: n });
          }),
          i = Ho(t),
          a = function (e, t, n) {
            var r,
          ...
          po(o.prototype, {
            ...
            forEach: function (e) {
              for (
                var t,
                  n = i(this),
                  r = br(e, arguments.length > 1 ? arguments[1] : void 0, 3);
                (t = t ? t.next : n.first);
  ...
  Pr || An(Object.prototype, "toString", Bo, { unsafe: !0 });
  var Fo = function (e) {
      return function (t, n) {
        var r,
          o,
        ...
        return 0 > a || a >= c
          ...
          : ((r = i.charCodeAt(a)),
            ...
            o > 57343
              ...
              : e
              ? i.slice(a, a + 2)
              : ((r - 55296) << 10) + (o - 56320) + 65536);
      };
    },
    Vo = { codeAt: Fo(!1), charAt: Fo(!0) },
    Uo = Vo.charAt,
    Go = "String Iterator",
    Wo = Sn.set,
    qo = Sn.getterFor(Go);
  Do(
    ...
    "String",
    function (e) {
      Wo(this, { type: Go, string: String(e), index: 0 });
    },
    function () {
      var e,
        t = qo(this),
  ...
  var Qo = {
    ...
    Zo = dr("unscopables"),
    Yo = Array.prototype;
  void 0 == Yo[Zo] && Kt.f(Yo, Zo, { configurable: !0, value: so({}) });
  var Jo = function (e) {
      Yo[Zo][e] = !0;
    },
    Ko = "Array Iterator",
    ...
    ei = Do(
      ...
      "Array",
      function (e, t) {
        Xo(this, { type: Ko, target: _t(e), index: 0, kind: t });
      },
      function () {
        var e = $o(this),
          t = e.target,
  ...
  var ui =
    ...
    pi =
      ...
      Ot(function () {
        ...
        ? function (e) {
            for (
              var t = lo(e), n = arguments.length, r = 1, o = Zn.f, i = jt.f;
              n > r;
              ...
              for (
                var a,
                  c = It(arguments[r++]),
                  u = o ? Qr(c).concat(o(c)) : Qr(c),
                  s = u.length,
                  p = 0;
                s > p;

              )
                (a = u[p++]), (!kt || i.call(c, a)) && (t[a] = c[a]);
            return t;
          }
        : ui;
  ir(
    { target: "Object", stat: !0, forced: Object.assign !== pi },
    { assign: pi }
  );
  var li =
      (Ln.Object.assign,
    ...
    di = function (e, t) {
      ...
      return (
        li(e) &&
          ((n = e.constructor),
          "function" != typeof n || (n !== Array && !li(n.prototype))
            ? zt(n) && ((n = n[fi]), null === n && (n = void 0))
            : (n = void 0)),
    ...
    wi = function (e, t) {
      ...
      return (yi[e] =
        ...
        !Ot(function () {
          if (r && !kt) return !0;
          var e = { length: -1 };
          r ? vi(e, 1, { enumerable: !0, get: bi }) : (e[1] = 1),
            n.call(e, o, i);
        }));
    },
    xi = hi.find,
  ...
  Pi in [] &&
    ...
    ir(
      { target: "Array", proto: !0, forced: Oi || !ki },
      {
        find: function (e) {
  ...
  ir(
    { target: "Array", proto: !0, forced: [].forEach !== Ci },
    { forEach: Ci }
  );
  var Di = (Si("Array", "forEach"), hi.some),
    ...
    Ii = wi("some");
  ir(
    { target: "Array", proto: !0, forced: !Mi || !Ii },
    {
      some: function (e) {
  ...
  var Ri,
    _i,
    zi = (Si("Array", "some"), Tn("navigator", "userAgent") || ""),
    Hi = Pt.process,
    Ni = Hi && Hi.versions,
    Bi = Ni && Ni.v8;
  Bi
    ? ((Ri = Bi.split(".")), (_i = Ri[0] + Ri[1]))
    : zi &&
      ((Ri = zi.match(/Edge\/(\d+)/)),
      (!Ri || Ri[1] >= 74) &&
        ((Ri = zi.match(/Chrome\/(\d+)/)), Ri && (_i = Ri[1])));
  var Fi = _i && +_i,
    Vi = dr("species"),
    Ui = function (e) {
      return (
    ...
    qi = wi("map");
  ir(
    { target: "Array", proto: !0, forced: !Wi || !qi },
    {
      map: function (e) {
  ...
  var Qi =
    ...
    $i = !Yi && Fi > 79 && 83 > Fi;
  ir(
    { target: "Array", proto: !0, forced: !Ki || !Xi || $i },
    {
      reduce: function (e) {
        return Ji(
          this,
  ...
  Si("Array", "reduce");
  ir(
    { target: "Object", stat: !0, forced: !kt, sham: !kt },
    { defineProperty: Kt.f }
  );
  var ea =
    (t(function (e) {
  ...
  var ta = (function () {
    ...
    ia = function (e, t) {
      for (
        var n = (t || document).getElementsByTagName("*"), r = [], o = 0;
        o < n.length;
        o++
      ) {
        var i = n[o];
    ...
    Ta = { placement: "bottom", modifiers: [], strategy: "absolute" },
    Ca = (K(), { passive: !0 }),
    Da = {
      name: "eventListeners",
      enabled: !0,
    ...
    Ma = { name: "popperOffsets", enabled: !0, phase: "read", fn: $, data: {} },
    Ia = { top: "auto", right: "auto", bottom: "auto", left: "auto" },
    Ra = {
      name: "computeStyles",
      enabled: !0,
      phase: "beforeWrite",
    ...
    qa = {
      PC: {
        ...
        PS: { GUARANTEE_HREF: "https://baozhang.baidu.com/guarantee/?from=ps" },
    ...
    Xa = function (e) {
      ...
      if (t) t.push(["_setAccount", Ka]), e && e();
        ...
        var r = function () {
          var r = n.readyState;
          ("undefined" == typeof r || /^(loaded|complete)$/.test(r)) &&
    ...
    ac = t(function (e, t) {
      ...
      !(function (r, o) {
        ...
        return (function (e) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              (t.createId = function () {
                return (
                  ...
                  parseInt(1e6 * Math.random(), 10).toString(16)
                );
              }),
              ...
              (t.sdkHost = function (e, t) {
                return t && /^https?:\/\/[^\/]+\.baidu\.com:\d+$/.test(t)
                  ? e.replace("https://ada.baidu.com", t)
                  : e;
              });
          },
          function (e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              (t.init = function (e) {
                var t = e.key;
                if (t)
                  return (e.status = 0), (e.pvt = +new Date()), (c[t] = e), e;
              }),
              (t.getData = r),
              (t.setPhone = function () {
                var e =
              ...
              (t.generateKeyForStore = function (e) {
                ...
                var r = t || n,
                  ...
                  i = e.realPhones || "";
                return (r +=
                  o.replace(/![0-9,a-z,A-z]/g, "") +
                  i.replace(/![0-9,a-z,A-z]/g, "") +
                  (e.mode || ""));
              }),
          ...
          function (e, t) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              (t.isSamePhoneNum = function (e, t) {
                ...
                var r = e.indexOf(t),
                  o = t.indexOf(e);
                return ((3 !== r && 4 !== r) || 0 !== e.indexOf("0")) &&
                  ((3 !== o && 4 !== o) || 0 !== t.indexOf("0"))
                  ? !1
                  : !0;
              }),
              (t.removeSymbol = n),
              (t.isMobileNum = r),
              (t.is400 = o),
              (t.getNumReplaceText = function (e) {
                if (o((e = i((e = n(e)))))) {
                  var t = [
                      e.substring(0, 3),
                      e.substring(3, 6),
          ...
          function (e, t) {
            function n(e, t, n, r) {
              var o = { logtype: r || "click" };
              "ad" === e.from && (o.phoneNum = t),
                "lp" === e.from && ((o.virtualPhone = t), (o.realPhone = n)),
                i(e, o);
            }
            function r() {
              var e =
            ...
            function o(e, t) {
              ...
              (t.phones = r.join("|")),
                e.bdVid && (t.bdVid = e.bdVid),
                e.pvt && (t.duration = +new Date() - e.pvt),
                "native-smart-app" === e.client &&
                  ((t.appName = e.appName), (t.appKey = e.appKey)),
                e.sourceType && (t.lpFrom = e.sourceType);
            }
            function i() {
              var e =
                  arguments.length > 0 && void 0 !== arguments[0]
            ...
            (t.init = function (e) {
              ...
              (t.nomatch = function (e, t) {
                i(e, { logtype: "nomatch", mtPhone: t });
              }),
              (t.log = r),
              (t.addComputeParams = o),
              (t.version = "3.0.14");
            var c = null,
              u = { ad: "ecom_virtual_phone", lp: "ec_bcp_virtualNum" },
              s = {
              ...
              l = { clickStatic: "click", clickDynamic: "click" };
          },
          function (e, t, n) {
            function r(e) {
              return (
                -1 !== e.indexOf("slp.baidu.com") ||
                -1 !== e.indexOf("sp0.baidu.com/5bgWsjip0QIZ8tyhnq")
              );
            }
            function o(e) {
            ...
            function i(e) {
              return (
                ...
                navigator &&
                navigator.userAgent &&
                navigator.userAgent.match(/baiduboxapp\/([\d+.]+)/)
              );
            }
            function a(e) {
              for (
            ...
            t.init = function () {
              ...
              r(n)
                ...
                ? (t = l.THIRD)
                : c(n) && (t = l.PREVIEW),
                s(e.sourceType) && (t = l.BAOZHANG);
              var f = {
                lpType: t,
                url: location.href,
                referrer: document.referrer,
              };
              p.getQuery("sdkhost", "search") &&
                (f.sdkhost = p.getQuery("sdkhost", "search"));
              try {
                if (c(n) || a(n)) {
              ...
              return (
                t === l.PREVIEW &&
                  (f.previewChannel = p.getQuery("channel", "search")),
                f
              );
            };
          },
          ...
          function (e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              (t.isFromAd = r),
              (t.isChargeUrl = o),
              (t.initAdParams = function (e) {
                var t = {
                  uid:
                    e.uid ||
                    window.bdDataLayer.uid ||
                    a.getReferrerQuery("cegduid") ||
                    a.getReferrerQuery("cegduid", "search") ||
                    a.getReferrerQuery("cegduid", "hash") ||
                    a.getReferrerQuery("BD_FC_UID"),
                  sid: window.bdDataLayer.sid,
                  baiduid: a.getCookie("BAIDUID"),
                  dpopen:
                    e.dpopen ||
                    window.bdDataLayer.dpopen ||
                    a.getReferrerQuery("dpopen") ||
                    1,
                ...
                if (
                  (e.solutionId &&
                    !e.solutionIds &&
                    ((t.solutionIds = e.solutionId), delete e.solutionId),
                  e.realPhone && !e.realPhones && (t.realPhones = e.realPhone),
                  "lp" === e.from)
                ) {
                  t.siteid = t.sid;
                  for (
                    var n = ["fid", "ch", "spid", "xst"], r = 0;
                    r < n.length;
                    r++
                  ) {
                    var o = n[r];
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                try {
                  ...
                  for (var s in t) {
                    var p = "",
                      l = void 0;
                    if (
                      ("number" == typeof t[s] && (p = 0),
                      "[object Object]" === u.call(t[s]))
                    ) {
                      try {
              ...
              (t.log = function (e, t) {
                ...
                for (var r in t)
                  t.hasOwnProperty(r) &&
                    n.push(
                      r + "=" + encodeURIComponent(void 0 === t[r] ? "" : t[r])
                    );
                n.push("rand=" + new Date().getTime()),
                  (e += "?" + n.join("&"));
                var o = new Image(),
                  i = 0;
                (o.onload =
                  ...
                  o.onabort =
                    function (t) {
                      return "error" === t.type && 2 > i
                        ? (i++, void (o.src = e + "&retryCount=" + i))
          ...
          function (e, t, r) {
                  ...
                  : (f.init(o),
                    ...
                    (function (e, t) {
                      var n = e.key,
                        ...
                        o = {
                          onResult: function (t) {
                            if ((f.setPhone(t, n), e.replaceFunc))
                              e.replaceFunc(e);
                            else {
                              var o = !1;
                              Array.isArray(t) &&
                              t[0] &&
                              (t[0].virtualPhone || t[0].dynamicPhone)
                                ? (o = !0)
                                : (t.virtualPhone || t.dynamicPhone) &&
                                  (o = !0),
                                o &&
                                  (a(n), d.show(r), e.callback && e.callback());
                            }
                          },
                          onError: function () {},
                        };
                      l.loadPhoneNumber(u({}, r, o, { mode: t }));
                    })(o, e.mode || "show"),
                    o.key);
              }
            }
            function i(e) {
              var t =
                ...
                r = (t.indexOf("click"), {});
              return (
                n || (r = { status: 4, virtualPhone: e, realPhone: null }),
                t && (n.dynamicPhone || n.virtualPhone)
                  ? "ad" === n.datafrom || g.isSamePhoneNum(e, n.realPhone)
                    ? n.dynamicPhone
                      ? f.checkExpired(n)
                        ? (f.setValue(t, "expired", 1),
                          (r = {
                            status: 0,
                            virtualPhone: n.virtualPhone
                              ? g.remove86(n.virtualPhone)
                              : e,
                            realPhone: e,
                            key: n.datakey,
                          }))
                ...
                (r.pageid = n.datapageid),
                n.datapvt && (r.duration = +new Date() - n.datapvt),
            ...
            (t.init = o),
              (t.getCallNumber = function (e) {
                ...
                if (
                  (n.callback && ((a.type = "show"), n.callback(a)),
                  r && n.callback)
                )
                  var s = o(
                    u(
              ...
              (t.getShowCallNumber = i),
              (t.delayTime = function (e, t, n) {
                var r = f.getData(e),
                  o = f.getPhone(e, n);
                if (o.dynamicPhone && g.isSamePhoneNum(t, o.dynamicPhone)) {
                  var i = {
                    onResult: function (t) {
                      f.setExpiredTime(e, n, t.expiredTime, t.hasHeart),
                        (o.hasHeart = t.hasHeart),
                        a(e, o);
                    },
                    onError: function () {},
                  };
                  l.delayPhoneTime(u({}, r, i, { phone: o }), n);
                }
              }),
              (t.checkHeart = a);
            var s,
              ...
              h = r(6),
              v = r(7),
              y = (s = v) && s.__esModule ? s : { default: s },
              b = (t.version = "3.0.14");
          },
          function (e, t, n) {
            function r(e) {
            ...
            (t.loadPhoneNumber = function (e) {
              var t = r(e),
                ...
                l = {
                  onResult: function () {
                    ...
                    var n = t.channel,
                      r = t.baiduid;
                    void 0 !== n && i.setValue(e.key, "channel", n),
                      r && i.setValue(e.key, "baiduid", r),
                      a(t);
                  },
                  onError: function (t) {
              ...
              (t.init = function () {
                var e =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : {};
                e.requestUtil && (s = e.requestUtil),
                  (p = a.sdkHost(p, e.sdkhost));
              }),
              (t.delayPhoneTime = function (e, t) {
                ...
                (i.dynamicPhone = e.phone.dynamicPhone),
                  ...
                  (i.sdkType = e.sdkType),
                  (i.expired = e.expired),
                  u.addComputeParams(o({}, e, { phone: [e.phone] }), i),
                  (i.rand = i.timestamp),
                  "ad" === e.from && (i.phoneNum = i.dynamicPhone),
                  "lp" === e.from &&
                    ((i.virtualPhone = i.dynamicPhone), (i.realPhone = t)),
                  s(p + "delayPhoneTime", i, a, { onResult: a, onError: c });
              }),
              (t.startHeart = function (e) {
                var t = r(e) || {},
                  ...
                  o = t.onResult,
                  i = t.onError;
                (n.dynamicPhone = e.phone.dynamicPhone),
                  (n.reqMd5 = e.phone.reqMd5),
                  s(p + "startHeart", n, o, { onResult: o, onError: i });
              });
            var i = n(1),
              a = n(0),
              c = n(2),
                ...
                getCallNumber: function () {
                  ...
                  return (
                    (0 !== e.status && 1 !== e.status) ||
                      (1 === e.status
                        ? (c.delayTime(e.key, e.virtualPhone, e.realPhone),
                          p.clickDynamic(
                            l.getData(e.key),
                            e.virtualPhone,
                            e.realPhone
                    ...
                    4 === e.status && p.requestExpired(l.getData(e.key)),
                    e
                  );
                },
                version: c.version,
    ...
    fc = function (e) {
      ...
      if (l && l.length) {
        ...
        x =
          "<div class='list bz-business-auth'>\n                <span class='label'>协会认证：</span>\n                <ul class='content'>\n                    ".concat(
            L.join(""),
            "\n                </ul>\n            </div>"
          );
      }
      f &&
        (f.pc || f.mobile) &&
        (O =
          "<a target='_blank' data-id='archives' class='btn look-archives' href=".concat(
            f[t.FIELD],
            ">查看档案</a>"
          ));
      var j = g && g.imUrl,
      ...
      (j || (T && !a)) &&
        (k = j
          ? "<a target='_blank' data-id='contact-customer' class='btn' href=".concat(
              j,
              ">\n                联系商家\n            </a>"
            )
          : "<span data-id='contact-customer' data-tel=".concat(
              T,
              " class='btn' id='showBaoZhangPhone'>联系商家</span>"
            ));
      var C = d && d.imUrl,
        D = C ? "联系百度" : "申请保障",
        M = C || c,
        I = "<a target='_blank' data-id='contact-baidu' class='btn' href="
          .concat(M, ">")
          .concat(D, "</a>");
  ...
  (gc.prototype.setPopperDom = function () {
    ...
    return (
      e.setAttribute("id", "guaranteePopper"),
      e.setAttribute("style", "z-index: " + r),
      e.setAttribute("class", o.CLASS_NAME),
    ...
    (gc.prototype.login = function () {
      function e() {
        ...
        window.location.href = e
          ? "".concat(n.LIVE_HREF).concat(encodeURIComponent(t))
          : "".concat(n.TEST_HREF).concat(encodeURIComponent(t));
      }
      var t = this.options,
        n = t.strategy,
        r = t.isLogin;
    ...
    (gc.prototype.bindEvent = function () {
      ...
      ta(e.contentDom, "mouseenter", n, !1),
        ta(e.contentDom, "mouseleave", t, !1),
        ta(e.reference, "mouseleave", t, !1),
        lc.push(function () {
          e.contentDom && na(e.contentDom, "mouseenter", n, !1),
            e.contentDom && na(e.contentDom, "mouseleave", t, !1),
            e.reference && na(e.reference, "mouseleave", t, !1);
        });
      ...
      r &&
        ...
        ta(
          ...
          function (t) {
            ...
            pc({ realPhone: o.phone }, function (e) {
              r.innerText = e;
            });
          },
          !1
    ...
    (gc.prototype.setLocation = function () {
      ...
      if (r) {
        ...
        var y = "left: "
          .concat(h, "px; top: ")
          .concat(v, "px; z-index: ")
          .concat(n, "; right: auto; bottom: auto; position: absolute");
        e.contentDom.setAttribute("style", y);
      } else
        this.popper = Wa(this.reference, this.contentDom, {
          placement: this.options.placement,
          modifiers: [
            { name: "offset", options: { offset: this.options.offset } },
    ...
    (gc.prototype.compatibleIE9Style = function () {
      ...
      if (t) {
        var r = u(),
          ...
          i = "btnOne";
        2 === o ? (i = "btnTwo") : 3 === o && (i = "btnThree"),
          this.contentDom.setAttribute(
            "class",
            n.CLASS_NAME + " popper-ie".concat(r, " ") + i
          );
      }
    });
  var mc = function () {
  ...
  gc.prototype.init = function () {
    ...
    if (
      (mc(),
      (this.reference = this.options.target),
      (this.reference =
        this.reference && this.reference.jquery
          ? this.reference[0]
          : this.reference),
      (this.contentDom = this.setPopperDom()),
      this.setLocation(),
      this.login(),
      this.bindEvent(),
      !this.options.isIE8)
  ...
  return { destory: mc, preset: Qa, showUp: hc };
});
