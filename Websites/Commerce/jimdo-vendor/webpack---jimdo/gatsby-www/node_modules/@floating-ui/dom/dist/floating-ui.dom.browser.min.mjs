...
function W(t, e) {
  ...
  const i = S(t),
    ...
    l = n(i);
  return r ? e.concat(l, l.visualViewport || [], a(i) ? i : []) : e.concat(i, W(i));
}
function D(e, i, r) {
  let l;
...
function V(t, e) {
  const n = F(t);
  return !(n === e || !f(n) || g(n)) && ("fixed" === o(n).position || V(n, e));
}
function A(t, e) {
...
const P = {
  getClippingRect: function (t) {
    ...
    const c = "clippingAncestors" === n ? function (t, e) {
        const n = e.get(t);
        if (n) return n;
        let i = W(t).filter(t => f(t) && "body" !== r(t)),
          l = null;
        ...
        for (; f(s) && !g(s);) {
          const e = o(s),
            n = h(s);
          n || "fixed" !== e.position || (l = null), (c ? !n && !l : !n && "static" === e.position && l && ["absolute", "fixed"].includes(l.position) || a(s) && !n && V(t, s)) ? i = i.filter(t => t !== s) : l = e, s = F(s);
        }
        return e.set(t, i), i;
      }(e, this._c) : [].concat(n),
      s = [...c, i],
...
function z(t, e, n, o) {
  ...
  const {
    ...
    s = i || r ? [...(f(t) ? W(t) : t.contextElement ? W(t.contextElement) : []), ...W(e)] : [];
  s.forEach(t => {
    const e = !f(t) && t.toString().includes("V");
  ...
  l && (a = new ResizeObserver(() => {
    n();
  }), f(t) && !c && a.observe(t), f(t) || !t.contextElement || c || a.observe(t.contextElement), a.observe(e));
  let d = c ? E(t) : null;
  return c && function e() {
    const o = E(t);
...
export { z as autoUpdate, k as computePosition, W as getOverflowAncestors, P as platform };